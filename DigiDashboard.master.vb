        ...
        Try
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)
                ...
                ElseIf Session("usertype") = "STAFF" Then
                    ...
                    staffmenu = "<li class='nav-item'><a href='#' data-toggle='dropdown' role='button' aria-expanded='false' class='nav-link dropdown-toggle'><span><i class='material-icons' style='color:#c6c6c6; font-size:10pt;'>people</i></span><span class='mini-dn' style='font-family:Cambria; text-align:center;     margin-left: 10px; font-size:11pt; color:#c6c6c6; '>   STAFF</span><span class='indicator-right-menu mini-dn'><i class='material-icons' style='color:#c6c6c6; font-size:8pt; padding-top:6px;'>play_arrow</i></span></a>" & _
                                    "<div role='menu' style='top: 0px;padding: 4px;overflow: visible;  max-height: 500px;' class='dropdown-menu left-menu-dropdown animated flipInX message-menu mCustomScrollbar _mCS_2 mCS-autoHide'>" & _
                    ...
                    If dr.Read = True Then
                        ...
                        Dim adminmenu As String = "<li class='nav-item'><a href='#' data-toggle='dropdown' role='button' aria-expanded='false' class='nav-link dropdown-toggle'><span><i class='material-icons' style='color:#c6c6c6; font-size:10pt;'>school</i></span><span class='mini-dn' style='font-family:Cambria; text-align:center;     margin-left: 10px; font-size:11pt; color:#c6c6c6; '>   ADMIN</span><span class='indicator-right-menu mini-dn'><i class='material-icons' style='color:#c6c6c6; font-size:8pt; padding-top:6px;'>play_arrow</i></span></a>" & _
                                    "<div  style='top: -110px;padding: 4px;  max-height: 500px;' id='scr' class='dropdown-menu left-menu-dropdown animated flipInX message-menu'>" & _
...
"<li><a href='" + path + "Content/admin/library.aspx" + "'>Manage Library</a></li></ul></li>"
                    ...
                    If dr2.Read = True Then
                        ...
                        Dim accmenu As String = "<li class='nav-item'><a href='#' data-toggle='dropdown' role='button' aria-expanded='false' class='nav-link dropdown-toggle'><span><i class='material-icons' style='color:#c6c6c6; font-size:10pt;'>business</i></span><span class='mini-dn' style='font-family:Cambria; text-align:center;     margin-left: 10px; font-size:11pt; color:#c6c6c6; '>   ACCOUNTS</span><span class='indicator-right-menu mini-dn'><i class='material-icons' style='color:#c6c6c6; font-size:8pt; padding-top:6px;'>play_arrow</i></span></a>" & _
                              "<div role='menu' style='top: 0px;padding: 4px;  max-height: 500px;' class='dropdown-menu left-menu-dropdown animated flipInX'>" & _
                    ...
                    If dr3.Read = True Then
                        ...
                        If dr3(0).ToString = "Early Years" Then
                            Dim ctmenu As String = "<li class='nav-item'><a href='#' data-toggle='dropdown' role='button' aria-expanded='false' class='nav-link dropdown-toggle'><span><i class='material-icons' style='color:#c6c6c6; font-size:10pt;'>class</i></span><span class='mini-dn' style='font-family:Cambria; text-align:center;     margin-left: 10px; font-size:11pt; color:#c6c6c6; '>   CLASS TEACHER</span><span class='indicator-right-menu mini-dn'><i class='material-icons' style='color:#c6c6c6; font-size:8pt; padding-top:6px;'>play_arrow</i></span></a>" & _
                                "<div role='menu' style='top: 0px;padding: 4px;  max-height: 500px;' class='dropdown-menu left-menu-dropdown animated flipInX'>" & _
                    ...
                    If dr4.Read = True Then
                        ...
                        Dim stmenu As String = "<li class='nav-item'><a href='#' data-toggle='dropdown' role='button' aria-expanded='false' class='nav-link dropdown-toggle'><span><i class='material-icons' style='color:#c6c6c6; font-size:10pt;'>bookmark</i></span><span class='mini-dn' style='font-family:Cambria; text-align:center;     margin-left: 10px; font-size:11pt; color:#c6c6c6; '>   SUBJECT TEACHER</span><span class='indicator-right-menu mini-dn'><i class='material-icons' style='color:#c6c6c6; font-size:8pt; padding-top:6px;'>play_arrow</i></span></a>" & _
                                                "<div role='menu' style='top: 0px;padding: 4px;  max-height: 500px;' class='dropdown-menu left-menu-dropdown animated flipInX'>" & _
                    ...
                    If teachingstaff.Count <> 0 Then
                        ...
                        Dim dhmenu As String = "<li class='nav-item'><a href='#' data-toggle='dropdown' role='button' aria-expanded='false' class='nav-link dropdown-toggle'><span><i class='material-icons' style='color:#c6c6c6; font-size:10pt;'>redeem</i></span><span class='mini-dn' style='font-family:Cambria; text-align:center;     margin-left: 10px; font-size:11pt; color:#c6c6c6; '>   DEPARTMENT HEAD</span><span class='indicator-right-menu mini-dn'><i class='material-icons' style='color:#c6c6c6; font-size:8pt; padding-top:6px;'>play_arrow</i></span></a>" & _
                                "<div role='menu' style='top: 0px;padding: 4px;  max-height: 500px;' class='dropdown-menu left-menu-dropdown animated flipInX'>" & _
                    ...
                    If classgroups.Count <> 0 Or subclassgroups.Count <> 0 Then
                        ...
                        Dim shmenu As String = "<li class='nav-item'><a href='#' data-toggle='dropdown' role='button' aria-expanded='false' class='nav-link dropdown-toggle'><span><i class='material-icons' style='color:#c6c6c6; font-size:10pt;'>panorama</i></span><span class='mini-dn' style='font-family:Cambria; text-align:center;     margin-left: 10px; font-size:11pt; color:#c6c6c6; '>   SCHOOL HEAD</span><span class='indicator-right-menu mini-dn'><i class='material-icons' style='color:#c6c6c6; font-size:8pt; padding-top:6px;'>play_arrow</i></span></a>" & _
                                "<div role='menu' style='top: 0px;padding: 4px;  max-height: 500px;' class='dropdown-menu left-menu-dropdown animated flipInX'>" & _
...
"<a href='" + path + "Content/staff/ssentmsgs.aspx" + "' class='dropdown-item'>Check Messages</a></div></li>"
                    ...
                    If super = True Then
                        ...
                        Dim phmenu As String = "<li class='nav-item'><a href='#' data-toggle='dropdown' role='button' aria-expanded='false' class='nav-link dropdown-toggle'><span><i class='material-icons' style='color:#c6c6c6; font-size:10pt;'>person_pin</i></span><span class='mini-dn' style='font-family:Cambria; text-align:center;     margin-left: 10px; font-size:11pt; color:#c6c6c6; '>   OVERALL HEAD</span><span class='indicator-right-menu mini-dn'><i class='material-icons' style='color:#c6c6c6; font-size:8pt; padding-top:6px;'>play_arrow</i></span></a>" & _
                                "<div role='menu' style='top: 0px;padding: 4px;  max-height: 500px;' class='dropdown-menu left-menu-dropdown animated flipInX'>" & _
                ...
                ElseIf Session("usertype") = "PARENT" Then
                    ...
                    parentmenu = parentmenu + "<li ><a href='" + path + "Content/parent/studentbehaviour.aspx'>ATTENDANCE</span> </a></li>"
                    ...
                    pmob = "<li><a href='" + path + "Content/parent/parentprofile.aspx" + "'>PROFILE</a></li>" & _
                                                     "<li><a href='" + path + "Content/parent/messages.aspx" + "'>MESSAGING</a></li>" & _
                                                      "<li><a href='" + path + "Content/parent/communicate.aspx" + "'>COMMUNICATION</a></li>" & _
                                                        "<li><a href='" + path + "Content/parent/studentbehaviour.aspx" + "'>ATTENDANCE</a></li>" & _
                ...
                End If
                Try
                    Dim er As Array = Split(Session("UserName"), " ")
                    lblUsername.Text = Char.ToUpper(er(0)(0)) & er(0).ToString.ToLower.Substring(1) & " " & Char.ToUpper(er(1)(0)) & er(1).ToString.ToLower.Substring(1)
                    lblUserType.Text = Char.ToUpper(Session("usertype")(0)) & Session("usertype").ToString.ToLower.Substring(1)

                Catch
                End Try
                Dim cmdCheck3 As New MySql.Data.MySqlClient.MySqlCommand("SELECT smsname, logo from options", con)

                Dim reader3 As MySql.Data.MySqlClient.MySqlDataReader = cmdCheck3.ExecuteReader
                reader3.Read()
                lblSchool.Text = reader3(0).ToString
                imgProf2.Src = reader3(1)
                reader3.Close()
        ...
        Try
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)
                ...
                Do While student1s.Read
                    If student1s("type").ToString = "" Then
                ...
                ElseIf Session("notified") < notno2 Then
                    Dim cmdLoad1s As New MySql.Data.MySqlClient.MySqlCommand("SELECT * from notifications where status = '" & "Unread" & "' and notifications.recipient = '" & user & "' order by time desc", con)
    ...
    Protected Sub lnkApp_Click(sender As Object, e As EventArgs) Handles lnkApp.Click
        Response.Redirect("~/ds.apk")
    End Sub
End Class
