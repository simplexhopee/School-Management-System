...
Partial Class Default2
    ...
    Private Sub load_time_table()
        Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)            con.open()
                ...
                Do While student10.Read
                    ...
                    If firstday = True Then
                        If student10(2).ToString = "Tutorial" Then
                            ds.Columns.Add(timestart(0) & ":" & timestart(1) & " - " & timeend(0) & ":" & timeend(1))
                            ds.Rows(x).Item(j) = timestart(0) & ":" & timestart(1) & " - " & timeend(0) & ":" & timeend(1)
                            j = j + 1
                        Else
                            ds.Columns.Add(timestart(0) & ":" & timestart(1) & " - " & timeend(0) & ":" & timeend(1))
                            ds.Rows(x).Item(j) = timestart(0) & ":" & timestart(1) & " - " & timeend(0) & ":" & timeend(1)
            ...
            GridView1.Width = 1700
            For Each c As BoundField In GridView1.Columns
                c.HeaderStyle.Width = 120
            Next
