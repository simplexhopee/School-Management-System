...
Partial Class Admin_addteacher
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.Open()
                ...
                Dim cmdCheck20 As New MySql.Data.MySqlClient.MySqlCommand("SELECT Subjects.subject as Subject, Class.class as Class, staffprofile.surname as Instructor, staffprofile.phone as Phone, courseoverview.overview as Overview, courseoverview.texts as Textbooks FROM classsubjects left join staffprofile on classsubjects.teacher = staffprofile.staffid left join courseoverview  on courseoverview.class = classsubjects.class and courseoverview.subject = classsubjects.subject inner join subjects on subjects.id = classsubjects.subject  inner join class on class.id = classsubjects.class where courseoverview.session = '" & Session("sessionid") & "' and class.Id = '" & Session("ClassId") & "' and subjects.subject = '" & Replace(Request.QueryString.ToString, "+", " ") & "'", con)
    ...
    Protected Sub lnkScore_Click(sender As Object, e As EventArgs) Handles lnkScore.Click
        Response.Redirect("~/content/student/scorehistory.aspx?" & Replace(Request.QueryString.ToString, "+", " "))
    End Sub
End Class
