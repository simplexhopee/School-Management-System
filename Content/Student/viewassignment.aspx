<%@ Page Title="" Language="VB" MasterPageFile="~/digidashboard.master" ValidateRequest=false AutoEventWireup="false" CodeFile="viewassignment.aspx.vb" Inherits="Admin_adminpage" %>
                                                     ...
                                                     <div class="form-group-inner">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                     <asp:Textbox cssclass="form-control" ID="txtDeadline" runat="server"  ></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
...
<td id="img2" runat ="server" class="auto-style2" >
 ...
 <br />
    ...
    <asp:Button ID="btnSend" runat="server" Text="Answer" cssclass="btn btn-sm btn-primary login-submit-cs buttonsnew"  />
