<%@ Page Title="" Language="VB" MasterPageFile="~/digidashboard.master" ValidateRequest=false AutoEventWireup="false" CodeFile="newassignment.aspx.vb" Inherits="Admin_adminpage" %>
...
<div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="form-select-list">
                                                                       <asp:DropDownList onchange="store()" cssclass = "form-control custom-select-value" ID="cboSubject" runat="server"  autopostback="true" >
