<%@ Page Title="" Language="VB" MasterPageFile="~/digidashboard.master" ValidateRequest=false AutoEventWireup="false" CodeFile="newmsg.aspx.vb" Inherits="Admin_adminpage" %>
...
<div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="form-select-list">
                                                                       <asp:DropDownList cssclass = "form-control custom-select-value" onchange="store()" ID="cboReceivetype" runat="server" autopostback="true"  >
                                                                                           <asp:ListItem Selected="True" Value="SELECT"></asp:ListItem>
                                                                                                <asp:ListItem Value="STAFF"></asp:ListItem>
                                                                                               
                                                                                                <asp:ListItem Value="PARENTS"></asp:ListItem>
                                                                                </asp:DropDownList>
                                                                     </div>
                                                                </div>
                                                            </div></div>
...
<div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="form-select-list">
                                                                       <asp:DropDownList cssclass = "form-control custom-select-value" onchange="store()" ID="cboCategory" runat="server"   >
                                                                                          
                                                                                </asp:DropDownList> <asp:linkButton onclientclick="store()" ID="Button1" runat="server" Text="Add" />
                                                                     </div>
                                                                </div>
                                                            </div></div>
                            ...
                            <div class="sparkline11-list shadow-reset mg-tb-30" style="margin:0; ">
                                ...
                                <div class="sparkline11-graph dashone-comment dashtwo-comment" style="overflow:auto; height:200px;" id="mydiv"  >
                                   ...
                                   <asp:GridView GridLines="None" autogeneratecolumns="false" class="newtable"  showheader="False"  id="gridRecipients" runat="server">
                                       <Columns>
                                           ...
                                           <asp:CommandField DeleteText="Remove" ShowDeleteButton="True"><controlstyle cssclass="btn btn-white btn-xs btn-group comment-replay-profile " /></asp:CommandField>
                                                         ...
                                                         <asp:CheckBox   checked="true" autopostback="true"  runat="server" ID="ChkPortal" Text="Send Portal Mesage"></asp:CheckBox>
    <br />
...
<td id="img2" runat ="server" class="auto-style2" >
 ...
 <br />
                  <asp:CheckBox checked="false" visible="false" onclick="store()" autopostback="true"   runat="server" ID="chkSendSMS" Text="Send SMS"></asp:CheckBox>
    <br />
