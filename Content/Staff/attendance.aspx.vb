    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
                Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                    con.open()
                    ...
                    readref2.Close()
                    Dim ref20 As New MySql.Data.MySqlClient.MySqlCommand("Select attendance.date  from attendance inner join class on class.id = attendance.class where class.class = '" & cboClass.Text & "' and attendance.term = '" & Session("SessionId") & "' and attendance.week = '" & cboWeek.Text & "' order by STR_TO_DATE(date,'%W, %M %d, %Y')", con)
    ...
    Protected Sub btnPrevious_Click(sender As Object, e As EventArgs) Handles btnTake.Click
        Try
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                ...
                student04.Close()
                con.close()            End Using
            Response.Redirect("~/content/Staff/newattendance.aspx")
        Catch ex As Exception
            Show_Alert(False, logify.error_log(sender.ToString, Replace(ex.ToString, "'", "")))
        End Try
    End Sub
