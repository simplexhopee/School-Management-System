...
Partial Class Admin_adminpage
    ...
    Protected Sub btnSend_Click(sender As Object, e As EventArgs) Handles btnSend.Click
        Try
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)
                ...
                logify.Notifications("You have a new message - " & txtSubject.Text, z, Session("staffid"), Session("msgClass") & " Class Teacher", receiveurl, "Message")
                ...
                cmdCheck2.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("sendertype", Session("msgClass") & " Class Teacher"))
 ...
 Dim msgobj as new Messages
  Dim s as new ds_functions
                        msgobj.Send_Email(msgobj.Get_Email(z), txtSubject.Text, message, "http://" & Request.Url.Authority, Session("msgClass") & " Class Teacher", s.Get_Staff_Name(Session("staffid")))
