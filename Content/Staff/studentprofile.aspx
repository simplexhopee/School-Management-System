   ...
   <br />
         ...
         <div class="row">
                   <div class="col-lg-5">
                                                        <div class="comment-replay-profile">
                                                            <div class="btn-group"> 
                                                                <asp:Button ID="lnkNew" class="btn btn-white btn-xs" TabIndex="8"  runat="server" Text="Add New Student" ></asp:Button>        
    <asp:Button ID="lnkAdd" class="btn btn-white btn-xs" TabIndex="8"  runat="server" Text="Add Existing Student" ></asp:Button></div></div> </div> </div> 
