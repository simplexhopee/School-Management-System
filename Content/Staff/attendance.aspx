<%@ Page Title="" Language="VB" MasterPageFile="~/digidashboard.master" AutoEventWireup="false" CodeFile="attendance.aspx.vb" Inherits="Admin_allstudents" %>
...
<div class="row">
    ...
    <div class="comment-replay-profile">
        ...
        <asp:GridView ID="GridView1" AutoGenerateColumns="False" runat="server" AllowPaging="True" PageSize="40" GridLines="None" class="newtable" >
              <Columns>
                   <asp:HyperLinkField DataTextField="date" HeaderText ="Date" DataNavigateUrlFields="date" DataNavigateUrlFormatString="~/content/Staff/newattendance.aspx?{0}" ><controlstyle cssclass="btn btn-white btn-xs btn-group comment-replay-profile " /> </asp:HyperLinkField>
