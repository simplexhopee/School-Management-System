                            ...
                            <div class="sparkline12-list shadow-reset mg-t-30">
                                <div class="sparkline12-hd">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <asp:Label ID="Label1" Font-Bold="true" Font-Size="Larger" runat="server" Text="Tests"></asp:Label>
          ...
          <div class="row">
                   <div class="col-lg-5">
                                                        <div class="comment-replay-profile">
                                                            <div class="btn-group">         
    <asp:Button ID="btnNewTest" class="btn btn-white btn-xs" TabIndex="8"  runat="server" Text="New Test" ></asp:Button>
         ...
         <br />
          ...
          <asp:GridView ID="GridView1" AutoGenerateColumns="False" runat="server" AllowPaging="True" PageSize="40" GridLines="None" class="newtable" >
             <Columns>
                   <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="~/content/staff/testdetails.aspx?{0}" Text="Details" >
            ...
            <asp:boundfield datafield="validate" headertext="Validated"/>
