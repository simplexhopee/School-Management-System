<%@ Page Title="" Language="VB" MasterPageFile="~/digidashboard.master" AutoEventWireup="false" CodeFile="studentbehaviour.aspx.vb" Inherits="Account_Default" %>
...
<br />
 ...
 <asp:Textbox TextMode="MultiLine"  cssclass="form-control" ID="txtRem" runat="server"  ></asp:Textbox>
                                                    ...
                                                    <div class="login-button-pro" style="text-align:right;" >  <asp:Button ID="btnMainUpdate" runat="server"  Text="Update" CssClass="btn btn-sm btn-primary login-submit-cs buttonsnew" /></div>
