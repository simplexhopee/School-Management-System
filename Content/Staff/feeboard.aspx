...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <asp:GridView runat="server" AutoGenerateColumns="False" showheader="False" ID="gridview1"  GridLines="None" class="newtable" >
            <Columns>
            ...
            <tr>
             ...
             <tr>
                <td class="auto-style9" >
                    ...
                    <asp:Label ID="Label3" runat="server"  Text="Previous Term's Balance" style="font-weight: 700"></asp:Label>
