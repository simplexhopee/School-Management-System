...
Partial Class Admin_allstudents
    ...
    Protected Sub btnExt_Click(sender As Object, e As EventArgs) Handles btnExt.Click
            ...
            Select Case cboLib.Text
                Case "SELECT LIBRARY"
                    Show_Alert(False, "Please select a library")
                Case "GOOGLE SCHOLARS"
                Response.Redirect("https://scholar.google.com/scholar?q=" & txtExternal.Text)
            Case "MIT OPEN COURSEWARE"
                Response.Redirect("https://ocw.mit.edu/search/ocwsearch.htm?q=" & txtExternal.Text)
                Case "EBSCO"
                    Response.Redirect("https://search.ebscohost.com")
                Case "JSTOR"
                Response.Redirect("https://jstor.org/action/doBasicSearch?Query=" & txtExternal.Text)
                Case "HINARI"
                    Response.Redirect("https://oaresciences.org")
                Case "SCIENCE DIRECT"
                Response.Redirect("https://sciencedirect.com/search/advanced?qs=" & txtExternal.Text)
                Case "ELETRONIC THESIS/DISERTATION"
                    Response.Redirect("https://thesis.patent-invent.com")
                Case "SAGE"
                Response.Redirect("https://online.sagepub.com/action/doSearch?filterOption=allJournal&AllField=" & txtExternal.Text)
                Case "ELIBRARY"
                    Response.Redirect("https://covenant.bravecontent.com")
                Case "WILEY ONLINE LIBRARY"
                Response.Redirect("https://onlinelibrary.wiley.com/action/doSearch?AllField=" & txtExternal.Text)
                Case "SCOPUS"
                    Response.Redirect("https://scopus.com")
            End Select
