    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                Dim cmdLoad1 As New MySql.Data.MySqlClient.MySqlCommand("SELECT lessonplan.id, lessonplan.date, lessonplan.week, staffprofile.surname, subjects.subject, class.class, lessonplan.status from lessonplan inner join staffprofile on staffprofile.staffid = lessonplan.teacher inner join class on lessonplan.class = class.id inner join subjects on lessonplan.subject = subjects.id where lessonplan.head  = '" & Session("StaffId") & "' order by lessonplan.date desc", con)
                Dim ds As New DataTable
                ds.Columns.Add("Reference")
                ds.Columns.Add("Date")
                ds.Columns.Add("Week")
                ds.Columns.Add("Teacher")
                ...
                Do While reader.Read
                    ds.Rows.Add(reader.Item(0), Convert.ToDateTime(reader(1)).ToString("dd/MM/yyyy hh:mm tt"), reader.Item(2), reader.Item(3), reader.Item(4), reader.Item(5), reader.Item(6))
                Loop
                reader.Close()
