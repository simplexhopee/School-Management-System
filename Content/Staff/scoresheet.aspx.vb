...
Partial Class Staff_scoresheet
    ...
    Sub Cummulative()
        ...
        Dim a As Array = db.Select_Query("select lastscore, lastscore2, total, id from subjectreg where class =  '" & Session("thisclass") & "' and session = '" & Session("sessionid") & "' and subjectsofferred = '" & IIf(Session("thissubid") <> Nothing, Session("thissubid"), Session("thissubnest")) & "'")
        ...
        For j = 0 To a.GetLength(1) - 2
            ...
            Dim k As Array = db.Select_Query("SELECT grades.lowest, grades.grade, grades.subject From grades inner join (gradingsystem inner join class on class.gradesystem = gradingsystem.id) on grades.system = gradingsystem.id Where class.id = '" & Session("thisclass") & "' order by grades.lowest desc")
   ...
   Private Sub Bind_Data()
        Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)
            ...
            If Session("thissubid") <> Nothing Then
                ...
                ElseIf caquery = 3 Then
                    Dim cmd As New MySql.Data.MySqlClient.MySqlCommand("SELECT StudentsProfile.admno as 'Reg No', studentsprofile.surname as 'Name', subjectreg.restest, subjectreg.test1, subjectreg.test2, subjectreg.ass, subjectreg.classwork, subjectreg.project, SubjectReg.examination as Exams, subjectreg.total as 'Total', subjectreg.grade as 'Grade', subjectreg.remarks as 'Remarks' FROM StudentsProfile INNER JOIN SubjectReg ON StudentsProfile.admno = SubjectReg.Student WHERE SubjectReg.nested = '" & 0 & "' and SubjectReg.SubjectsOfferred = ? And SubjectReg.Session = ? And SubjectReg.Class = ? ORDER BY StudentsProfile.surname", con)
                    cmd.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("SubjectReg.SubjectsOfferred", Session("thissubid")))
                    cmd.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("SubjectReg.Session", Session("Selectterm")))
                    cmd.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("SubjectReg.Class", Session("thisclass")))
                    Dim ds As New DataTable
    ...
    Sub Prin_Remarks()
        Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)
            ...
            cmd100a.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("SubjectReg.student", Session("thisclass")))
            cmd100a.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("SubjectReg.stu", Session("Selectterm")))
            ...
            For Each s As Double In totala
                Dim cmd22 As New MySql.Data.MySqlClient.MySqlCommand("SELECT grades.lowest, grades.average From grades inner join (gradingsystem inner join class on class.gradesystem = gradingsystem.id) on grades.system = gradingsystem.id Where class.id = '" & Session("thisclass") & "' order by grades.lowest desc", con)
    ...
    Protected Sub btnMainUpdate_Click(sender As Object, e As EventArgs) Handles btnMainUpdate.Click
        Try
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)
                con.Open()
                Dim cmdCheck3 As New MySql.Data.MySqlClient.MySqlCommand("SELECT * FROM Subjects WHERE Subject = ?", con)
                ...
                For Each row As GridViewRow In GridView1.Rows
                    ...
                    Dim g As TextBox = row.FindControl("txtrestest")
					dim restest as string = g.Text

                    Dim h As TextBox = row.FindControl("txtclasswork")
					dim classwork as string = h.Text
					
					Dim i As TextBox = row.FindControl("txtass")
					dim ass as string = i.Text
					
					
					Dim j As TextBox = row.FindControl("txtproject")
					dim project as string = j.Text
					
					Dim k As TextBox = row.FindControl("txttest1")
					dim test1 as string = k.Text
					
					Dim l As TextBox = row.FindControl("txttest2")
					dim test2 as string = l.Text
					
					
                    Dim w As TextBox = row.FindControl("txtexams")
                    Dim exam As String = w.Text
					...
					Dim total As Double = Val(restest) + Val(classwork) + val(ass) + Val(project) + Val(test1) + Val(test2) + Val(exam)
                    Dim cmd22 As New MySql.Data.MySqlClient.MySqlCommand("SELECT grades.lowest, grades.grade, grades.subject From grades inner join (gradingsystem inner join class on class.gradesystem = gradingsystem.id) on grades.system = gradingsystem.id Where class.id = '" & Session("thisclass") & "' order by grades.lowest desc", con)
                    Dim graderead As MySql.Data.MySqlClient.MySqlDataReader = cmd22.ExecuteReader
                    Dim remarks As String = ""
                    Dim grade As String = ""
                    ...
                    graderead.Close()
                    If Session("thissubid") <> Nothing Then
                        Dim UpdateDatabase As New MySql.Data.MySqlClient.MySqlCommand("UPDATE SubjectReg SET restest = '" & restest & "', test1 = '" & test1 & "', test2 = '" & test2 & "', ass = '" & ass & "', classwork = '" & classwork & "', project = '" & project & "', subjectreg.Grade = ?, subjectreg.Remarks = ?, SubjectReg.Examination = ?, Total = ? WHERE SubjectReg.student = ? and subjectreg.nested = '" & 0 & "' and SubjectReg.Subjectsofferred = ? and subjectreg.class = ? and subjectreg.session = ?", con)
                        UpdateDatabase.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("SubjectReg.grade", grade))
                        UpdateDatabase.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("SubjectReg.remarks", remarks))
                        UpdateDatabase.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("SubjectReg.Examination", exam))
                        UpdateDatabase.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("SubjectReg.Total", total))
                ...
                Class_Position()
                Prin_Remarks()
                If Session("term") = "3rd term" Then Cummulative()
    ...
    Protected Sub lnkexport_Click(sender As Object, e As EventArgs) Handles lnkExport.Click
        Try
            ...
            If Session("thissubid") <> Nothing Then
                ...
                ElseIf caquery = 3 Then
                    Dim cmd As New MySql.Data.MySqlClient.MySqlCommand("SELECT StudentsProfile.admno as 'Reg No', studentsprofile.surname as 'Name', subjectreg.restest as 'Resumption Test', subjectreg.test2 as 'Test 2', subjectreg.test3 as 'Test 3', subjectreg.ass1 as 'Take Home Assignment 1', subjectreg.ass2 as 'Take Home Assignment 2', subjectreg.ass3 as 'Take Home Assignment 3', subjectreg.quiz as 'Quiz', subjectreg.debate as 'Debate', subjectreg.classwork as 'Class Work', subjectreg.attendance as 'Attendance', subjectreg.appearance as 'Appearance', subjectreg.honesty as 'Honesty', punctuality as 'Punctuality', relat as 'Relationship with Others', note as 'Note Copying', pracproj as 'Practical Project', SubjectReg.examination as 'Exams' FROM StudentsProfile INNER JOIN SubjectReg ON StudentsProfile.admno = SubjectReg.Student WHERE subjectreg.nested = '" & 0 & "' and SubjectReg.SubjectsOfferred = ? And SubjectReg.Session = ? And SubjectReg.Class = ? ORDER BY StudentsProfile.surname", con)
                    cmd.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("SubjectReg.SubjectsOfferred", Session("thissubid")))
                    cmd.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("SubjectReg.Session", Session("Selectterm")))
                    cmd.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("SubjectReg.Class", Session("thisclass")))
        ...
        Try
            ...
            If Session("thissubid") <> Nothing Then
                For Each row As DataRow In dt.Rows
					...
					dim restest as string = row.Item(2).ToString
					
					dim test2 as string = row.Item(3).ToString
					
					dim test3 as string = row.Item(4).ToString
					
					dim CA as double = val(restest) + val(test2) + val(test3)
					
					dim ass1 as string = row.Item(5).ToString
					
					dim ass2 as string = row.Item(6).ToString
					
					dim ass3 as string = row.Item(7).ToString
					
					dim assignments as double = val(ass1) + val(ass2) + val(ass3)
					
					dim quiz as string = row.Item(8).ToString
					
					dim debate as string = row.Item(9).ToString
					
					dim classwork as string = row.Item(10).ToString
					
					dim classexcercise as double = val(quiz) + val(debate) + val(classwork)
					
					Dim CA1 As double = CA + assignments + classexcercise 
                    
					dim attendance as string = row.Item(11).ToString
					
					dim appearance as string = row.Item(12).ToString
					
					dim honesty as string = row.Item(13).ToString
					
					dim punctuality as string = row.Item(14).ToString
					
					dim relat as string = row.Item(15).ToString
					
					dim CA2 as double = val(attendance) + val(appearance) + val(honesty) + val(punctuality) + val(relat)
					
					
					dim note as string = row.Item(16).ToString
					
					dim pracproj as string = row.Item(17).ToString
					
					dim CA3 as double = val(note) + val(pracproj)
					
					
					
					
                   dim exam as string = row.Item(18).ToString

                    

                   

                    Dim testtotal As Double = Val(CA1) + Val(CA2) + Val(CA3)                    
					Dim total As Double = testtotal + Val(exam)
                    Dim cmd22 As New MySql.Data.MySqlClient.MySqlCommand("SELECT grades.lowest, grades.grade, grades.subject From grades inner join (gradingsystem inner join class on class.gradesystem = gradingsystem.id) on grades.system = gradingsystem.id Where class.id = '" & Session("thisclass") & "' order by grades.lowest desc", con)
                    Dim graderead As MySql.Data.MySqlClient.MySqlDataReader = cmd22.ExecuteReader
                    Dim remarks As String = ""
                    ...
                    graderead.Close()
                        ...
                        Dim UpdateDatabase As New MySql.Data.MySqlClient.MySqlCommand("UPDATE SubjectReg SET restest = '" & restest & "', test2 = '" & test2 & "', test3 = '" & test3 & "', ass1 = '" & ass1 & "', ass2 = '" & ass2 & "', ass3 = '" & ass3 & "', quiz = '" & quiz & "', debate = '" & debate & "', classwork = '" & classwork & "', attendance = '" & attendance & "', appearance = '" & appearance & "', honesty = '" & honesty & "', punctuality = '" & punctuality & "', relat = '" & relat & "', note = '" & note & "', pracproj = '" & pracproj & "', CA = '" & CA & "', assignments = '" & assignments & "', classexcercise = '" & classexcercise & "',  SubjectReg.CA1 = ?, SubjectReg.CA2 = ?, SubjectReg.CA3 = ?, subjectreg.Grade = ?, subjectreg.Remarks = ?, SubjectReg.testtotal = ?, SubjectReg.Examination = ?, Total = ? WHERE SubjectReg.student = ? and subjectreg.nested = '" & 0 & "' and SubjectReg.Subjectsofferred = ? and subjectreg.class = ? and subjectreg.session = ?", con)
                        UpdateDatabase.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("SubjectReg.CA1", CA1))
                        UpdateDatabase.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("SubjectReg.CA2", CA2))
                        UpdateDatabase.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("SubjectReg.CA3", CA3))
                        UpdateDatabase.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("SubjectReg.grade", grade))
    ...
    Protected Sub GridView2_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GridView2.RowDataBound
        Dim cbo As DropDownList = e.Row.FindControl("cboRemark")
        cbo.Items.Clear()
        cbo.Items.Add("Select Remark")
        cbo.Items.Add("Deeloping")
        cbo.Items.Add("Developed")
        cbo.Items.Add("Mastered")
    End Sub
