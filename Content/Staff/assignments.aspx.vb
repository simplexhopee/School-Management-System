...
Partial Class Admin_allstudents
    ...
    Protected Sub GridView1_RowDeleting(sender As Object, e As GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        Try
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                ...
                Dim cmd2 As New MySql.Data.MySqlClient.MySqlCommand("Delete from assignments where class = ? and subject = ? and title = ?", con)
    ...
    Protected Sub btnMsg_Click(sender As Object, e As EventArgs) Handles btnMsg.Click
        Response.Redirect("~/content/Staff/newassignment.aspx")
    End Sub
