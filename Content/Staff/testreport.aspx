<%@ Page Title="" Language="VB" MasterPageFile="~/digidashboard.master" AutoEventWireup="false" CodeFile="testreport.aspx.vb" Inherits="Admin_allstudents" %>
    ...
    <asp:Button ID="btnBack" class="btn btn-white btn-xs" TabIndex="8"  runat="server" Text="Back" ></asp:Button>
         ...
         <br />
          ...
          <asp:GridView ID="GridView1" AutoGenerateColumns="False" runat="server" AllowPaging="True" PageSize="40" GridLines="None" class="newtable" >
             <Columns>
                                    <asp:HyperLinkField DataNavigateUrlFields="id" DataNavigateUrlFormatString="~/content/staff/reviewtest.aspx?{0}" Text="View Details" >
