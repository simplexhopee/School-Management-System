<%@ Page Title="" Language="VB" MasterPageFile="~/digidashboard.master" AutoEventWireup="false" CodeFile="smessages.aspx.vb" Inherits="Admin_allstudents" %>
     ...
     <div class="form-group-inner">
         ...
         <br />
          ...
          <asp:GridView ID="GridView1" AutoGenerateColumns="False" runat="server" AllowPaging="True" GridLines="None" class="newtable" >
              <Columns>
                   <asp:HyperLinkField DataNavigateUrlFields="ID,receiver" DataNavigateUrlFormatString="~/content/Staff/sreadmsg.aspx?id={0}&amp;receiver={1}" Text="Read" ><controlstyle cssclass="btn btn-white btn-xs btn-group comment-replay-profile " /></asp:hyperlinkfield>
