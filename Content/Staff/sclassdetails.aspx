<%@ Page Title="" Language="VB" MasterPageFile="~/digidashboard.master" AutoEventWireup="false" CodeFile="sclassdetails.aspx.vb" Inherits="Admin_studentprofile" %>
...
<div class="row">
       ...
       <div class="row">
                   <div class="col-lg-5">
                                                        <div class="comment-replay-profile">
                                                            <div class="btn-group">         
    <asp:Button ID="lnkStudents" class="btn btn-white btn-xs" TabIndex="8"  runat="server" Text="View Students" ></asp:Button></div></div> </div> </div> 
 ...
 <div class="all-form-element-inner">
     ...
     <asp:GridView ID="GridView1"  AutoGenerateColumns="False" ShowHeader="False"  runat="server" GridLines="None" class="newtable">
 ...
 <div class="all-form-element-inner">
     ...
     <asp:GridView ID="GridView2" AutoGenerateColumns ="False" ShowHeader="False"  runat="server" GridLines="None" class="newtable" >
             <Columns>
                 ...
                 <asp:boundfield datafield="name" />
                   ...
                   <asp:ImageField DataImageUrlField="passport" HeaderText="passport">
                        <controlstyle BorderStyle="None" Height="50px" Width="50px" />
                                             ...
                                             <asp:HyperLinkField DataNavigateUrlFields="subject"  DataNavigateUrlFormatString="~/content/Staff/coursedetails.aspx?{0}" Text="Course Details" > <controlstyle cssclass="btn btn-white btn-xs btn-group comment-replay-profile" /></asp:HyperLinkField>
