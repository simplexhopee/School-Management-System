...
Partial Class Admin_adminpage
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                If Request.QueryString.ToString <> Nothing And Not IsPostBack Then
                    ...
                    ElseIf sendername = "Staff" Then
                        ...
                        student1.Close()
                    ElseIf sendername = "Parents" Then
                    ...
                    ElseIf sendername = "Accounts" Then
                        ...
                        student1.Close()
                    End If
                    Dim cmdCheck3 As New MySql.Data.MySqlClient.MySqlCommand("Update messages set status = '" & "Read" & "' where id = '" & Request.QueryString.ToString & "' and receiver = '" & Session("staffid") & "'", con)
    ...
    Protected Sub btnReply_Click(sender As Object, e As EventArgs) Handles btnReply.Click
        ...
        Response.Redirect("~/content/staff/newmsg.aspx?" & Request.QueryString.ToString)
