<%@ Page Title="" Language="VB" MasterPageFile="~/digidashboard.master" AutoEventWireup="false" CodeFile="sstudentprofile.aspx.vb" Inherits="Admin_studentprofile" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div class="all-form-element-inner">
     ...
     <br />
       <asp:DetailsView ID="DetailsView3" runat="server" GridLines="None" class="newtable">
     ...
     <br />
      <asp:DetailsView ID="DetailsView2" runat="server" GridLines="None" class="newtable">
                            </asp:DetailsView>
...
<asp:Panel runat="server" id="panel2" visible="false" > 
     ...
     <br />
      <asp:DetailsView ID="DetailsView4" runat="server" GridLines="None" class="newtable">
                            </asp:DetailsView>
