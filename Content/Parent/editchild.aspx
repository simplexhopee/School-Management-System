<%@ Page Title="" Language="VB" MasterPageFile="~/digidashboard.master" AutoEventWireup="false" CodeFile="editchild.aspx.vb" Inherits="Admin_adminpage" %>

<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    
                <h2>EDIT CHILD/WARD'S PROFILE</h2>

              <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="0" OnNextButtonClick="Wizard1_NextButtonClick" style="font-size: small" DisplaySideBar="False" Width="100%" FinishDestinationPageUrl="~/content/parent/studentprofile.aspx">
