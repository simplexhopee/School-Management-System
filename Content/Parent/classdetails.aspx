<%@ Page Title="" Language="VB" MasterPageFile="~/digidashboard.master" AutoEventWireup="false" CodeFile="classdetails.aspx.vb" Inherits="Account_Default" %>
                 ...
                 <asp:boundfield datafield="name" />
                   ...
                   <asp:ImageField DataImageUrlField="passport" HeaderText="passport">
                        <controlstyle BorderStyle="None" Height="50px" Width="50px" />
                                             ...
                                             <asp:HyperLinkField DataNavigateUrlFields="subject"  DataNavigateUrlFormatString="~/content/parent/courseoverview.aspx?{0}" Text="Course Details" > <controlstyle cssclass="btn btn-white btn-xs btn-group comment-replay-profile" /></asp:HyperLinkField>
