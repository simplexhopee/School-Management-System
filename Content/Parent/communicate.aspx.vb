...
Partial Class Admin_studentprofile
    ...
    Sub load_chats()
        ...
        db.Non_Query("update communicate set status = 'Read' where sender <> '" & (Session("parentid")) & "' and student = '" & Session("studentadd") & "'")
        Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)
            con.Open()
            ...
            Do While student0.Read
                ...
                logify.Read_notification("~/content/parent/communicate.aspx?" & student0("id"), Session("parentid"))
    ...
    Protected Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Try
            ...
            Do While student0.Read
                    logify.Notifications("You have a new message - Child Activity", student0(0), Session("parentid"), par.getstuname(Session("studentadd")) & " Parent", "~/content/staff/communicate.aspx?" & id, "")
                Loop
                student0a.Close()
