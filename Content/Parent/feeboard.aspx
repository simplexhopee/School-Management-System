           ...
           <tr>
                ...
                <td class="auto-style9" >
                   ...
                   <div class="col-lg-5">
                                                        <div class="comment-replay-profile">
                                                            <div class="btn-group">         
    <asp:Button ID="btnPay" visible="false" class="btn btn-white btn-xs" TabIndex="8"  runat="server" Text="View Schedule" ></asp:Button><asp:Button ID="btnReceipt" class="btn btn-white btn-xs" TabIndex="8"  runat="server" visible="false" Text="View Receipt" ></asp:Button></div></div> </div> </div> 
