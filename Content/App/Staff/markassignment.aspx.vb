        ...
        Try
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.Open()
                ...
                If Request.QueryString.ToString <> Nothing And Not IsPostBack Then
                    logify.Read_notification("~/content/app/staff/markassignment.aspx?" & Request.QueryString.ToString, Session("staffid"))
    ...
    Protected Sub btnSend_Click(sender As Object, e As EventArgs) Handles btnSend.Click
        Try
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                ...
                Dim msg As MySql.Data.MySqlClient.MySqlDataReader = cmdCheck2.ExecuteReader
                msg.Read()
                logify.Notifications("Your " & txtSubject.Text & " assignment has been marked.", msg(0), Session("staffid"), txtSubject.Text & " TEACHER", "~/content/app/student/viewmarked.aspx?" & Request.QueryString.ToString, "")
                If par.getparent(msg(0)) <> "" Then logify.Notifications(txtSubject.Text & "assignment given to " & txtStudent.Text & " has been marked ", par.getparent(msg(0)), Session("staffid"), txtSubject.Text & " TEACHER", "~/content/app/parent/viewmarked.aspx?" & Request.QueryString.ToString, "")
