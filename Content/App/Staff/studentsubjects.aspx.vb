            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                ...
                For Each item As String In checkedSubjects
                    ...
                    If isOfferred = False Then
                        ...
                        logify.Notifications(item & " was added to your subjects.", Session("studentadd"), Session("staffid"), "Class Teacher", "~/content/app/parent/classdetails.aspx", "")
                        If par.getparent(Session("studentadd")) <> "" Then logify.Notifications(item & " was added to the subjects offerred by " & par.getstuname(Session("studentadd")), par.getparent(Session("studentadd")), Session("staffid"), DropDownList1.Text & " Class Teacher", "~/content/app/parent/classdetails.aspx?" & Session("studentadd"), "")
                ...
                For Each item As String In uncheckedSubjects
                    ...
                    If isOfferred = True Then
                        ...
                        logify.Notifications(item & " was removed from your subjects.", Session("studentadd"), Session("staffid"), "Class Teacher", "~/content/app/student/classdetails.aspx?", "")
                        If par.getparent(Session("studentadd")) <> "" Then logify.Notifications(item & " was removed from the subjects offerred by " & par.getstuname(Session("studentadd")), par.getparent(Session("studentadd")), Session("staffid"), DropDownList1.Text & " Class Teacher", "~/content/app/parent/classdetails.aspx?" & Session("studentadd"), "")
