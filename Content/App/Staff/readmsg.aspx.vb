...
Partial Class Admin_adminpage
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)
                ...
                dim a as array = split(Request.QueryString.ToString, "&")


                    logify.Read_notification("~/content/staff/readmsg.aspx?" & a(0), Session("staffid"))
    ...
    Protected Sub btnReply_Click(sender As Object, e As EventArgs) Handles btnReply.Click
        ...
        Response.Redirect("~/content/app/staff/newmsg.aspx?" & Request.QueryString.ToString)
