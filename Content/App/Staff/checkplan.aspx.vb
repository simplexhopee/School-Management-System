...
Partial Class Admin_adminpage
        ...
        Try
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.Open()
                ...
                If Request.QueryString.ToString <> Nothing And Not IsPostBack Then
                    logify.Read_notification("~/content/app/staff/checkplan.aspx?" & Request.QueryString.ToString, Session("staffid"))
    ...
    Protected Sub btnSend_Click(sender As Object, e As EventArgs) Handles btnSend.Click
        Try
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                ...
                Dim cmdCheck20 As New MySql.Data.MySqlClient.MySqlCommand("Update lessonplan set remarks = ?, status = ? where Id = '" & Request.QueryString.ToString & "'", con)
                cmdCheck20.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("title", txtRem.Text))
                cmdCheck20.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("assignment", "Marked"))
                cmdCheck20.ExecuteNonQuery()
                logify.log(Session("staffid"), "Lesson plan of " & par.getstaff(Session("lessonplansender")) & "was marked")
                logify.Notifications("Your lesson plan for Week " & txtWeek.Text & " " & txtSubject.Text & " - " & txtClass.Text & " has been marked", Session("lessonplansender"), Session("staffid"), "HOD", "~/content/app/staff/markedplan.aspx?" & Request.QueryString.ToString, "")
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Response.Redirect("~/content/app/staff/submittedplans.aspx")
    End Sub
End Class
