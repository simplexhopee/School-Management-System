<%@ Page Title="" Language="VB" MasterPageFile="~/DigicontentApp.master" ValidateRequest=false AutoEventWireup="false" CodeFile="sreadsent.aspx.vb" Inherits="Admin_adminpage" %>
...
<br />
                                                       ...
                                                       <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Recipients</label>
                                                                </div>
                                                               <div class="col-lg-9">
                                                                    <div class="form-select-list">
                                                                      <asp:ListBox ID="Listbox1" runat="server"  cssclass="form-control custom-select-value"></asp:ListBox>
                                                                        </div>
                                                                </div>
                                                            </div>
                                                        </div>
