<%@ Page Title="" Language="VB"  MaintainScrollPositionOnPostBack="True" MasterPageFile="~/digicontentApp.master" AutoEventWireup="false" CodeFile="communicate.aspx.vb" Inherits="Admin_studentprofile" %>
       ...
       <div class="row">
                        <div class="col-lg-12">
                            <div >
                                <div class="sparkline12-hd">
                                    <div class="main-sparkline12-hd">
                                        <h1>Conversation Thread - <asp:Label runat="server" id="lblstudent"></asp:Label></h1>
