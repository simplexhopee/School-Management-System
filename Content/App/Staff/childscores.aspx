<%@ Page Title="" Language="VB" MasterPageFile="~/DigicontentApp.master" AutoEventWireup="false" CodeFile="childscores.aspx.vb" Inherits="Account_Default" %>
 ...
 <div class="all-form-element-inner">
      ...
      <table class="table" runat="server" id="tblstats">
            ...
            <tr>
             ...
             <tr>
               <td><asp:Label ID="Label1" runat="server" style="font-size: small; font-weight: 700" Text="Comments:"></asp:Label></td>
                <td><asp:label ID="txtRem" runat="server" ></asp:label></td>
            </tr>
