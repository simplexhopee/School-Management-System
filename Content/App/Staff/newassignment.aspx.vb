    ...
    Protected Sub btnSend_Click(sender As Object, e As EventArgs) Handles btnSend.Click
        Try
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                ...
                Loop
                readref.Close()
                Dim dob As Date = txtDeadline.Text
                ...
                If Request.QueryString.ToString <> Nothing Then
                    ...
                    cmdCheck20.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("deadline", FormatDateTime(dob, DateFormat.GeneralDate)))
                ...
                Else
                    ...
                    Dim student0 As MySql.Data.MySqlClient.MySqlDataReader = cmdLoad0.ExecuteReader
                    Do While student0.Read
                        logify.Notifications("An assignment was given in " & cboSubject.Text, student0(0), Session("staffid"), cboSubject.Text & " TEACHER", "~/content/app/Student/viewassignment.aspx?" & y, "assignment")
                        If par.getparent(student0(0)) <> "" Then logify.Notifications("An assignment was given in " & cboSubject.Text & " to " & par.getstuname(student0(0)), par.getparent(student0(0)), Session("staffid"), cboSubject.Text & " TEACHER", "~/content/app/parent/viewassignment.aspx?" & y, "")
                    Loop
                    student0.Close()
