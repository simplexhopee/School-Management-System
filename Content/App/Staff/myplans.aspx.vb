...
Partial Class Admin_allstudents
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.Open()
                Dim cmdLoad1 As New MySql.Data.MySqlClient.MySqlCommand("SELECT lessonplan.id, cast(lessonplan.date as char) as date, lessonplan.week, subjects.subject, class.class, lessonplan.status from lessonplan inner join staffprofile on staffprofile.staffid = lessonplan.teacher inner join class on lessonplan.class = class.id inner join subjects on lessonplan.subject = subjects.id where lessonplan.teacher  = '" & Session("StaffId") & "' order by lessonplan.date desc", con)
    ...
    Protected Sub lnkNew_Click(sender As Object, e As EventArgs) Handles lnkNew.Click
        Response.Redirect("~/content/app/staff/newplan.aspx")
    End Sub
End Class
