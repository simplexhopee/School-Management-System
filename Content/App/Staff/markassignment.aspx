<%@ Page Title="" Language="VB" MasterPageFile="~/DigicontentApp.master" ValidateRequest=false AutoEventWireup="false" CodeFile="markassignment.aspx.vb" Inherits="Admin_adminpage" %>
...
<br />
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Student</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                     <asp:Textbox cssclass="form-control" ID="txtStudent" runat="server"  ></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                         <div class="form-group-inner">
...
<div class="form-group-inner">
    ...
    <asp:Button ID="btnSend" runat="server" Text="Mark" cssclass="btn btn-sm btn-primary login-submit-cs buttonsnew"  />
