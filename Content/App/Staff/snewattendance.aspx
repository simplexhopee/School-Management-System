<%@ Page Title="" Language="VB" MasterPageFile="~/DigicontentApp.master" AutoEventWireup="false" CodeFile="snewattendance.aspx.vb" Inherits="Admin_allstudents" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div class="all-form-element-inner">
     ...
     <asp:GridView ID="GridView1" AutoGenerateColumns="False" runat="server"  GridLines="None" class="table" >
              <Columns>
