<%@ Page Title="" Language="VB" MasterPageFile="~/DigicontentApp.master" AutoEventWireup="false" CodeFile="sclassdetails.aspx.vb" Inherits="Admin_studentprofile" %>
                 ...
                 <asp:boundfield datafield="name" />
                   ...
                   <asp:ImageField DataImageUrlField="passport" HeaderText="passport">
                        <controlstyle BorderStyle="None" Height="50px" Width="50px" />
                                             ...
                                             <asp:HyperLinkField DataNavigateUrlFields="subject"  DataNavigateUrlFormatString="~/content/app/Staff/coursedetails.aspx?{0}" Text="Course Details" > <controlstyle cssclass="btn btn-white btn-xs btn-group comment-replay-profile" /></asp:HyperLinkField>
