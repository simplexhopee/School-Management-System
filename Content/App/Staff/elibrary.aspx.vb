...
Partial Class Admin_allstudents
    ...
    Protected Sub btnMsg_Click(sender As Object, e As EventArgs) Handles btnMsg.Click
        Response.Redirect("~/content/app/admin/addbooks.aspx")
    End Sub
    ...
    Protected Sub btnExt_Click(sender As Object, e As EventArgs) Handles btnExt.Click
            ...
            Select Case cboLib.Text
                ...
                Case "GOOGLE SCHOLARS"
                    Response.Redirect("http://scholar.google.com/scholar?q='" & txtExternal.Text)
                Case "MIT OPEN COURSEWARE"
                    Response.Redirect("http://ocw.mit.edu")
                Case "EBSCO"
                    Response.Redirect("http://search.ebscohost.com")
                Case "JSTOR"
                    Response.Redirect("http://jstor.org")
                Case "HINARI"
                    Response.Redirect("http://oaresciences.org")
                Case "SCIENCE DIRECT"
                    Response.Redirect("http://sciencedirect.com")
                Case "ELETRONIC THESIS/DISERTATION"
                    Response.Redirect("http://thesis.patent-invent.com")
                Case "SAGE"
                    Response.Redirect("http://online.sagepub.com")
                Case "ELIBRARY"
                    Response.Redirect("http://covenant.bravecontent.com")
                Case "WILEY ONLINE LIBRARY"
                    Response.Redirect("http://onlinelibrary.wiley.com")
                Case "SCOPUS"
                    Response.Redirect("http://scopus.com")
            End Select
