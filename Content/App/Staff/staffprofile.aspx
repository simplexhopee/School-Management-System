...
<div class="form-group-inner">
                                                        ...
                                                        </div> <div class="login-button-pro" style="text-align:left;" >  
    ...
    <asp:Panel id="pnlTaught" visible="false" runat="server">
 ...
 <div class="all-form-element-inner">
      ...
      <div id ="taught" runat ="server" ><asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" class="table"  GridLines="None" >
            <Columns>
    ...
    <asp:Panel id="pnlClass" visible="false" runat="server">
                                ...
                                <div class="sparkline12-graph">
                                    <div class="basic-login-form-ad">
                                        <div class="row">
                                            <div class="col-lg-12">
 <div class="all-form-element-inner">
         <div id ="manage" runat ="server" ></div>
 ...
 <div class="all-form-element-inner">
    ...
    <asp:Panel id="pnlDept" visible="false" runat="server">
                <div class="row">
                        <div class="col-lg-12">
                            <div class="sparkline12-list shadow-reset mg-t-30">
                                <div class="sparkline12-hd">
                                    <div class="main-sparkline12-hd">
                                        <h1>Deprtments Belonged to</h1>
