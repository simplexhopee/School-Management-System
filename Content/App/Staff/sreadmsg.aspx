<%@ Page Title="" Language="VB" MasterPageFile="~/DigicontentApp.master" ValidateRequest=false AutoEventWireup="false" CodeFile="sreadmsg.aspx.vb" Inherits="Admin_adminpage" %>
                                                        ...
                                                        <div class="form-group-inner">
                                                         ...
                                                         <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                     <asp:Textbox cssclass="form-control" ID="txtReceiver" enabled="false" runat="server"  ></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                         <div class="form-group-inner">
