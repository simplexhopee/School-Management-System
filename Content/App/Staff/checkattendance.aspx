<%@ Page Title="" Language="VB" MasterPageFile="~/DigicontentApp.master" AutoEventWireup="false" CodeFile="checkattendance.aspx.vb" Inherits="Admin_allstudents" %>
...
<div class="row">
    ...
    <div class="comment-replay-profile">
        ...
        <asp:GridView ID="GridView1" AutoGenerateColumns="False" runat="server" AllowPaging="True" PageSize="40" GridLines="None" class="table" >
              <Columns>
                   <asp:HyperLinkField DataTextField="date" HeaderText ="Date" DataNavigateUrlFields="date" DataNavigateUrlFormatString="~/content/app/Staff/snewattendance.aspx?{0}" ><controlstyle cssclass="btn btn-white btn-xs btn-group comment-replay-profile " /> </asp:HyperLinkField>
