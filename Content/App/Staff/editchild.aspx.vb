            ...
            If Wizard1.ActiveStep Is WizardStep1 Then
                Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                    con.open()
                    ...
                    If rcomfirm.HasRows Then
                        ...
                        logify.Notifications(msg, txtID.Text, Session("staffid"), "CLASS TEACHER", "~/content/app/student/studentprofile.aspx", "")
                        logify.Notifications("The profile of " & par.getstuname(txtID.Text) & " was updated by the Class Teacher", par.getparent(txtID.Text), Session("staffid"), par.getstuname(txtID.Text) & " CLASS TEACHER", "~/content/app/parent/studentprofile.aspx?" & txtID.Text, "")

                        Response.Redirect("~/content/app/staff/studentprofile.aspx")
                    Else
                        Response.Redirect("~/content/app/staff/studentprofile.aspx")
                    End If
                    con.close()                End Using
