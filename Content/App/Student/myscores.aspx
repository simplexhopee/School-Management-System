<%@ Page Title="" Language="VB" MasterPageFile="~/digicontent.master" AutoEventWireup="false" CodeFile="myscores.aspx.vb" Inherits="Account_Default" %>
     ...
     <div class="comment-replay-profile">
      ...
      <div class="row">
                   <div class="col-lg-5">
                                                        <div class="comment-replay-profile">
                                                            <div class="btn-group">         
    <asp:Button ID="Button1" class="btn btn-white btn-xs" TabIndex="8"  runat="server" visible="false" Text="View Result" ></asp:Button></div></div> </div> </div> 
