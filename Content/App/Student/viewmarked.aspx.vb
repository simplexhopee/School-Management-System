        ...
        Try
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                ...
                If Request.QueryString.ToString <> Nothing And Not IsPostBack Then
                    ...
                    Dim cmdCheck2 As New MySql.Data.MySqlClient.MySqlCommand("SELECT subjects.subject, class.class, assignments.title, submittedassignments.answer, staffprofile.surname, submittedassignments.remarks, submittedassignments.score from submittedassignments inner join (assignments inner join staffprofile on staffprofile.staffid = assignments.teacher) on submittedassignments.assignment = assignments.id inner join subjects on subjects.Id = submittedassignments.subject inner join class on class.id = submittedassignments.class where submittedassignments.id = '" & Request.QueryString.ToString & "'", con)
