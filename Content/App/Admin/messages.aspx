<%@ Page Title="" Language="VB" MasterPageFile="~/digicontentapp.master" AutoEventWireup="false" CodeFile="messages.aspx.vb" Inherits="Admin_allstudents" %>
 ...
 <asp:Button ID="btnSMS" runat="server" class="btn btn-white btn-xs" Text="SMS Reports"></asp:Button>
         ...
         <br />
          ...
          <asp:GridView ID="GridView1" AutoGenerateColumns="False" runat="server" AllowPaging="True" PageSize="40" GridLines="None" class="table" >
             <Columns>
                   <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="~/content/App/App/App/Admin/readmsg.aspx?{0}" Text="Read" >
