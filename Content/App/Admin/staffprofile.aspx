<%@ Page Title="" Language="VB" MasterPageFile="~/digicontentapp.master" AutoEventWireup="false" CodeFile="staffprofile.aspx.vb" Inherits="Admin_staffprofile" %>
 ...
 <asp:GridView runat="server" AutoGenerateColumns="False" showheader="False" ID="gridview1"  GridLines="None" class="table" AllowPaging="True">
    ...
    <div class="row"><div class="row" id="dd" style="margin:5px;text-align:center;">
                        <span class="picspan" "  >  <asp:Image  ID="Image1" ImageUrl="~/img/noimage.jpg" CssClass="picsupload"  runat="server" /> </span> <br /> </div> 
                           ...
                           <asp:CheckBox ID="chkActivated" runat="server" autopostback="true" class="form control" />
...
<div class="row">
    ...
    <br />
    <div id ="taught" class="row" runat ="server" ><h4>Subjects Taught</h4>
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" class="table"  GridLines="None" >
            <Columns>
        ...
        <div class="row">
                   <div class="col-lg-5">
                                                        <div class="comment-replay-profile">
                                                            <div class="btn-group">         
    <asp:Button ID="LinkButton2" class="btn btn-white btn-xs"  runat="server" Text="Edit Subjects"></asp:Button></div></div> </div> </div> 

   
                <br />
    <div id ="manage" runat ="server" ><h4>Classes Managed</h4></div>
                <div class="row">
                     <div class="col-lg-5">
                                                        <div class="comment-replay-profile">
                                                            <div class="btn-group">         
    <asp:Button ID="LinkButton3" class="btn btn-white btn-xs"  runat="server" Text="Edit Classes"></asp:Button></div></div> </div> </div> 

    
            <br />
            <div id ="role" runat ="server" ><h4>School Roles</h4></div>
                <div class="row">
                     <div class="col-lg-5">
                                                        <div class="comment-replay-profile">
                                                            <div class="btn-group">         
    <asp:Button ID="LinkButton5" class="btn btn-white btn-xs"  runat="server" Text="Edit Roles"></asp:Button></div></div> </div> </div> 
