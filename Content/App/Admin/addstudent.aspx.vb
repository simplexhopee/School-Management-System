...
Partial Class Admin_adminpage
    ...
    Protected Sub Wizard1_FinishButtonClick(sender As Object, e As WizardNavigationEventArgs) Handles Wizard1.FinishButtonClick
        Try
                ...
                If txtExistPPhone.Text <> "" Then
                    ...
                    Else
                        ...
                        If hasguardian = False Then
                            ...
                            logify.Notifications("You have been made the parent of " & txtSurname.Text, txtPID.Text, Session("staffid"), "Admin", "~/content/App/App/parent/studentprofile.aspx", "")
                        Else
            ...
            Response.Redirect("~/content/App/App/App/Admin/studentprofile.aspx")
        ...
        Try
            If Wizard1.ActiveStep Is WizardStep1 Then
                Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                    con.Open()
                    ...
                    Dim rcomfirm As MySql.Data.MySqlClient.MySqlDataReader = comfirm.ExecuteReader
                    rcomfirm.Read()
                    If rcomfirm.HasRows And txtID.Enabled = False Then
                        rcomfirm.Close()
                        ...
                        logify.Notifications(msg, txtID.Text, Session("staffid"), "Admin", "~/content/App/App/student/studentprofile.aspx", "")
                        logify.Notifications("The profile of " & par.getstuname(txtID.Text) & " was updated by Admin", par.getparent(txtID.Text), Session("staffid"), "Admin", "~/content/App/App/parent/studentprofile.aspx?" & txtID.Text, "")
                        ...
                        If Session("senders") <> Nothing Then
                            ...
                            Response.Redirect(x)
                        Else
                            Response.Redirect("~/content/App/App/App/Admin/studentprofile.aspx?" & Request.QueryString.ToString)

                        End If
                    ElseIf txtID.Enabled = True And Not rcomfirm.HasRows Then
                        rcomfirm.Close()
                ...
                Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                    con.open()
                    If CheckBox1.Checked = True Then
                        ...
                        Else
                            ...
                            logify.Notifications("You are now a boarder in " & cboHostel.Text, txtID.Text, Session("staffid"), "Admin", "~/content/App/App/student/studentprofile.aspx", "")
                        End If
                    End If
                    If CheckBox2.Checked = True Then
                        ...
                        Else
                            ...
                            logify.Notifications("You are now on transport. Route = " & cboTransport.Text, txtID.Text, Session("staffid"), "Admin", "~/content/App/App/student/studentprofile.aspx", "")
                        End If
                    End If
            ...
            ElseIf Wizard1.ActiveStep Is clas Then
                ...
                Else
                    Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                        con.open()
                        ...
                        logify.Notifications("You are now a student of " & cboClass.Text, txtID.Text, Session("staffid"), "Admin", "~/content/App/App/student/classdetails.aspx", "")
                        con.Close()
                    End Using
                End If
