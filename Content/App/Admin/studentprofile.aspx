 ...
 <div class="all-form-element-inner">
     ...
     <div class="row">
                   <div class="col-lg-5">
                                                        <div class="comment-replay-profile">
                                                            <div class="btn-group">         
    <asp:Button ID="lnkClass" class="btn btn-white btn-xs" TabIndex="8"  runat="server" Text="Change Class" ></asp:Button> <asp:Button ID="BtnTraits" class="btn btn-white btn-xs" TabIndex="8"  runat="server" Text="Readd Traits" ></asp:Button></div></div> </div> </div> 
