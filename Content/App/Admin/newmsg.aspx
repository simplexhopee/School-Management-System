...
<div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="form-select-list">
                                                                       <asp:DropDownList cssclass = "form-control custom-select-value" ID="cboReceivetype" runat="server" autopostback="true"  >
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="form-select-list">
                                                                       <asp:DropDownList cssclass = "form-control custom-select-value" ID="cboCategory" runat="server"   >
                                                                                ...
                                                                                </asp:DropDownList> <asp:linkButton ID="Button1" runat="server" Text="Add" />
                                                                     </div>
                                                                </div>
                                                            </div></div>
                                   ...
                                   <asp:GridView GridLines="None" autogeneratecolumns="false" class="table"  showheader="False"  id="gridRecipients" runat="server">
                                       <Columns>
                                           ...
                                           <asp:CommandField DeleteText="Remove" ShowDeleteButton="True"><controlstyle cssclass="btn btn-white btn-xs btn-group comment-replay-profile " /></asp:CommandField>
                                                         ...
                                                         <asp:CheckBox checked="false" autopostback="true"  runat="server" ID="ChkPortal" Text="Send Portal Mesage"></asp:CheckBox>
    <br />
...
<td id="img2" runat ="server" class="auto-style2" >
 ...
 <br />
                  <asp:CheckBox checked="false" autopostback="true"   runat="server" ID="chkSendSMS" Text="Send SMS"></asp:CheckBox>
    <br />
...
<div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12">
                                                                     <asp:Textbox class="form-control" ID="txtSMS" runat="server" textmode="multiline" height="20%"  ></asp:TextBox>
