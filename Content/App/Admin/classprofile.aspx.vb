...
Partial Class Admin_studentprofile
    ...
    Protected Sub LinkButton1_Click(sender As Object, e As EventArgs) Handles LinkButton1.Click
        ...
        Session("senders") = "~/content/App/Admin/classprofile.aspx?school=" & Session("schoolselect") & "&currentclass=" & Session("classselect")
        Response.Redirect("~/content/App/Admin/addstudent.aspx?" & Session("studentadd"))
    End Sub
    ...
    Protected Sub lnkClass_Click(sender As Object, e As EventArgs) Handles lnkClass.Click
        ...
        Response.Redirect("~/content/App/Admin/newclass.aspx")
