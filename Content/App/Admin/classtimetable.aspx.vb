...
Partial Class Default2
        ...
        Try
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                If Not IsPostBack Then
                    ...
                    Loop
                    studentx.Close()
                    Dim cmdLoad As New MySql.Data.MySqlClient.MySqlCommand("SELECT class.class from ttname inner join class on ttname.school = class.superior where ttname.id = '" & Request.QueryString("timetable") & "'", con)
    ...
    Protected Sub LinkButton1_Click(sender As Object, e As EventArgs) Handles LinkButton1.Click
        Response.Redirect("~/content/App/App/App/Admin/manageclass.aspx?" & Session("clid"))
    End Sub
End Class
