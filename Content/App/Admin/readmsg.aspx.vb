...
Partial Class Admin_adminpage
        ...
        Try
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                If Request.QueryString.ToString <> Nothing And Not IsPostBack Then
                    ...
                    Dim c As Integer = 1
                    Do While msg2.Read
                        Dim imgsrc As New fileimage

                        If c = 1 Then
                            Panel1.Visible = True

                            icon1.Src = imgsrc.get_image(msg2(1).ToString)
    ...
    Protected Sub btnReply_Click(sender As Object, e As EventArgs) Handles btnReply.Click
        ...
        Response.Redirect("~/content/App/Admin/newmsg.aspx?" & Request.QueryString.ToString)
