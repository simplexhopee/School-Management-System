<%@ Page Title="" Language="VB" MasterPageFile="~/digicontentapp.master" AutoEventWireup="false" CodeFile="newtimetable.aspx.vb" Inherits="Admin_addclass" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <h2><asp:Label runat="server" Text="NEW TIME TABLE"></asp:Label></h2>
    ...
    <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="0"  style="font-size: small" DisplaySideBar="False" Width="100%" startNextButtonCss="btn-small btn-skin btn-block btn-lg" FinishCompleteButtonText="Generate">
     ...
     <asp:ListItem Value="School Based"></asp:ListItem>
        <asp:ListItem Value="Class Based"></asp:ListItem>

</asp:RadioButtonList>                 <asp:Panel ID="pnlSchool" runat="server"  Visible="False">
<div class="form-group-inner">
<div class="row">
                                                                <div class="col-lg-3">
...
<div class="row">
 ...
 <div class="login-button-pro" style="text-align:right;" >   <asp:Button ID="BtnManualAdd" runat="server" class="btn btn-sm btn-primary login-submit-cs buttonsnew" Text="Add" />
