<%@ Page Title="" Language="VB" MasterPageFile="~/digicontentapp.master" AutoEventWireup="false" CodeFile="classprofile.aspx.vb" Inherits="Admin_studentprofile" %>
    ...
    <div class="row">
                   <div class="col-lg-5">
                                                        <div class="comment-replay-profile">
                                                            <div class="btn-group">         
    <asp:Button ID="lnkclrpt" class="btn btn-white btn-xs" TabIndex="8"  runat="server" Text="Class Report" ></asp:Button> <asp:Button ID="lnkschrpt" class="btn btn-white btn-xs" TabIndex="8"  runat="server" Text="School Report" ></asp:Button></div></div> </div> </div> 
         <br />
     ...
     <br />
      <div class="row">
                   <div class="col-lg-5">
                                                        <div class="comment-replay-profile">
                                                            <div class="btn-group">         
    <asp:Button ID="lnkParent" class="btn btn-white btn-xs" TabIndex="8"  runat="server" Text="Edit Parent" ></asp:Button></div></div> </div> </div> 
 ...
 <div class="all-form-element-inner">
     ...
     <div class="row">
                   <div class="col-lg-5">
                                                        <div class="comment-replay-profile">
                                                            <div class="btn-group">         
    <asp:Button ID="lnkClass" class="btn btn-white btn-xs" TabIndex="8"  runat="server" Text="Change Class" ></asp:Button></div></div> </div> </div> 
...
<div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="form-select-list">
                                                                       <asp:DropDownList cssclass = "form-control custom-select-value" ID="cboHostel" runat="server" enabled="false" autopostback="true"  ></asp:DropDownList> 
...
<div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="form-select-list">
                                                                       <asp:DropDownList cssclass = "form-control custom-select-value" ID="cboTransport" runat="server" enabled="false" autopostback="true" >
...
<div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="form-select-list">
                                                                       <asp:DropDownList cssclass = "form-control custom-select-value" ID="cboAdm" runat="server" autopostback="true" >
