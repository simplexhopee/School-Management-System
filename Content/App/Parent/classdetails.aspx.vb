 ...
 End If 
        Try
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                ...
                logify.Read_notification("~/content/App/App/parent/classdetails.aspx?" & Request.QueryString.ToString, Session("parentid"))
    ...
    Protected Sub lnkTimeTable_Click(sender As Object, e As EventArgs) Handles lnkTimeTable.Click
        Try
            ...
            End Using
            If exists = True Then
                Response.Redirect("~/content/App/App/student/viewtimetable.aspx?timetable=" & id)
