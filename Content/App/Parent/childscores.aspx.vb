...
Partial Class Account_Default
 ...
 End If 
        ...
        Try
            ...
            If type = "Early Years" Then
                If exams = True Then
                    ...
                    Response.Redirect("~/content/App/App/Student/result.aspx")
                Else
                    Show_Alert(False, "Report not yet published.")
                    Exit Sub
                End If
            Else
                Student_Details()
    ...
    Protected Sub lnkResult_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Response.Redirect("~/content/App/App/App/Student/result.aspx")
    End Sub
