...
Partial Class Admin_adminpage
 ...
 End If 
                ...
                For Each item As String In recipient
                    ...
                    If z = "Admin" Then
                        ...
                        Do While reader.Read
                            logify.Notifications("You have a new message - " & txtSubject.Text, reader(0).ToString, Session("parentid"), Session("Relationship"), "~/content/App/App/admin/readmsg.aspx?" & y, "Message")
                    ...
                    ElseIf z = "Accounts" Then
                        ...
                        Dim reader As MySql.Data.MySqlClient.MySqlDataReader = cmdLoad1.ExecuteReader
                        Do While reader.Read
                            logify.Notifications("You have a new message - " & txtSubject.Text, reader(0).ToString, Session("parentid"), Session("Relationship"), "~/content/App/App/account/readmsg.aspx?" & y, "Message")

                        Loop
                        reader.Close()
                    Else
                        logify.Notifications("You have a new message - " & txtSubject.Text, z, Session("parentid"), Session("Relationship"), "~/content/App/App/staff/readmsg.aspx?" & y, "Message")
                    End If
                    recno = recno + 1
                Next
    ...
    Protected Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        Response.Redirect("~/content/App/App/parent/messages.aspx")
    End Sub
    ...
    Protected Sub btnUpload_Click(sender As Object, e As EventArgs) Handles btnUpload.Click
        Try
            Dim folderPath As String = Server.MapPath("~/content/App/App/Uploads/")
            Dim q As String
            If FileUpload1.HasFile Then
                FileUpload1.SaveAs(folderPath & Path.GetFileName(FileUpload1.FileName))
                q = "https://" & Request.Url.Authority & "/content/App/App/Uploads/" & FileUpload1.FileName
