<%@ Page Title="" Language="VB" MasterPageFile="~/digicontentapp.master" AutoEventWireup="false" CodeFile="elearning.aspx.vb" Inherits="Account_Default" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div class="all-form-element-inner">
    ...
    <div class="row">
                   <div class="col-lg-5">
                                                        <div class="comment-replay-profile">
                                                            <div class="btn-group"> <asp:Button ID="Button3" class="btn btn-white btn-xs"  runat="server" Text="All Children"></asp:Button>        </div>
    <br />
    <br />
    <div class="comment-replay-profile">
 ...
 <asp:GridView ID="GridView2" AutoGenerateColumns="False" runat="server" AllowPaging="True" PageSize="40"  GridLines="None" class="table">
              <Columns>
                   <asp:HyperLinkField DataNavigateUrlFields="reference" DataNavigateUrlFormatString="~/content/App/App/Student/viewelearning.aspx?{0}" Text="View" ><controlstyle cssclass="btn btn-white btn-xs btn-group comment-replay-profile " /></asp:hyperlinkfield>
