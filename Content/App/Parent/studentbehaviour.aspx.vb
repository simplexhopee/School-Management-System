        ...
        Try
            ...
            If Not IsPostBack Then
                Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                    con.Open()
                    ...
                    logify.Read_notification("~/content/App/App/parent/studentbehaviour.aspx?" & Request.QueryString.ToString, Session("parentid"))
                    logify.Read_notification("~/content/App/App/parent/studentbehaviour.aspx", Session("parentid"))
