 ...
 End If 
        ...
        Else
                Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                    con.open()
                    logify.Read_notification("~/content/App/App/parent/studentprofile.aspx?" & Request.QueryString.ToString, Session("parentid"))
                    logify.Read_notification("~/content/App/App/parent/studentprofile.aspx", Session("parentid"))
    ...
    Protected Sub LinkButton1_Click(sender As Object, e As EventArgs) Handles LinkButton1.Click
        ...
        Response.Redirect("~/content/App/App/parent/editchild.aspx")
    End Sub
