<%@ Page Title="" Language="VB" MaintainScrollPositionOnPostBack="True" MasterPageFile="~/Digichat.master" AutoEventWireup="false" CodeFile="communicate.aspx.vb" Inherits="Admin_studentprofile" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div class="all-form-element-inner">
  ...
  <div class="row">
                   <div class="col-lg-10">
                                                        <div class="comment-replay-profile">
                                                            <div class="btn-group">  <span id="subfm" style='height:50px; padding:8px;width:50px'><input id='Button1f'  onclick="showhideemoji()" style='background-color:transparent; border-style:none; font-size: 16px; vertical-align: middle; margin-top: 10px;' type='button' value='😃' /> <asp:Button ID="Button10" onclientclick="store()" runat="server" class="btn btn-sm btn-primary login-submit-cs buttonsnew" text="Send"  />  <asp:Button ID="Button9" runat="server" class="btn btn-sm btn-primary login-submit-cs buttonsnew" visible="false" Text="Preset Message" /></span></div> </div> </div> </div> 
                    </div>
    ...
    <asp:Button ID="Button16" class="btn btn-white btn-xs" TabIndex="8"  runat="server" Text="Back" ></asp:Button></div></div> </div> </div> 
        ...
        <div class="sparkline11-list shadow-reset mg-tb-30" style="margin:0; vertical-align:middle;">
                            ...
                            <div class="welcome-wrapper shadow-reset res-mg-t mg-b-30 sparkline11-graph dashone-comment dashtwo-comment comment-scrollbar" style="height:400px; background-image: url('../../img/noimage.jpg'); background-repeat: no-repeat; background-position-x: center;">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" >
                            <div class="sparkline11-list shadow-reset mg-tb-30" style="margin:0;">
                                ...
                                <div class="sparkline11-graph dashone-comment dashtwo-comment comment-scrollbar" style="height:400px; background-image: url('../../img/noimage.jpg'); background-repeat: no-repeat; background-position-x: center;">
