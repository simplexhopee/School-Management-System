 ...
 End If 
        Try
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                Dim cmdLoad1 As New MySql.Data.MySqlClient.MySqlCommand("SELECT id, cast(date as char) as date, receivertype, receiver, subject from sentmsgs where sender = '" & Session("ParentId") & "'  order by date desc", con)
    ...
    Protected Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Try
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                Dim cmdLoad1 As New MySql.Data.MySqlClient.MySqlCommand("SELECT id, date, receivertype, receiver, subject from sentmsgs where sender = '" & Session("ParentId") & "' and subject like ?  order by date desc", con)
    ...
    Protected Sub btnMsg_Click(sender As Object, e As EventArgs) Handles btnMsg.Click
        Response.Redirect("~/content/App/App/parent/newmsg.aspx")
    End Sub
