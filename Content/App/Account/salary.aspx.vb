...
Partial Class Account_salary
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            For j As Integer = 2018 To Now.Year + 1
        ...
        Try
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                ...
                For Each item As String In staff
                    ...
                    logify.Notifications("You have a new message - " & "Salary payment", item, Session("staffid"), "Accounts", "~/content/app/staff/readmsg.aspx?" & ys, "Message")
                Next
        ...
        Try
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                ...
                If generated = False Then
                    ...
                    Do While rcomfirm.Read
                        salary.Add(Val(rcomfirm.Item("salary")))
    ...
    Protected Sub lnkPrint_Click(sender As Object, e As EventArgs) Handles lnkPrint.Click
        Response.Redirect("~/content/app/account/salprint.aspx")
    End Sub
End Class
