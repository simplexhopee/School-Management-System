...
Partial Class Account_salary
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Label4.Text = "Please add Sessional fees here"
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                Dim cmd1 As New MySql.Data.MySqlClient.MySqlCommand("SELECT * from sessionalfees", con)
    ...
    Protected Sub Wizard1_FinishButtonClick(sender As Object, e As WizardNavigationEventArgs) Handles Wizard1.FinishButtonClick
        ...
        lblFsuccess.Text = ""
        Response.Redirect("~/Account/sessionalfees.aspx")
    ...
    Protected Sub Wizard1_NextButtonClick(sender As Object, e As WizardNavigationEventArgs)
        If Wizard1.ActiveStep Is WizardStep2 Then
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                Dim delete As New MySql.Data.MySqlClient.MySqlCommand("Delete From sessionalfees", con)
                delete.ExecuteNonQuery()
                For Each item As ListItem In ListBox2.Items
                    Dim i() As String = Split(item.Text, "-")

                    Dim insert As New MySql.Data.MySqlClient.MySqlCommand("Insert Into sessionalfees (fee, amount) Values (?,?)", con)
