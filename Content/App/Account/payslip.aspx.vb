...
Partial Class Student_result
    ...
    Protected Sub form1_Load(sender As Object, e As EventArgs) Handles form1.Load
        ...
        Dim cmdSelect2 As New MySql.Data.MySqlClient.MySqlCommand("SELECT staffprofile.staffid, staffprofile.surname, staffprofile.designation, staffprofile.salary as basic, salschedule.tax, salschedule.pension, salschedule.bills, salschedule.deductions as deduction, salschedule.increments as increment, salschedule.welfare, salschedule.net, salschedule.month, salschedule.year from staffprofile inner join salschedule on salschedule.staffId = staffprofile.staffId where month = ? and year = ? and staffprofile.staffid = ?", con2)
        ...
        cmdSelect2.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("staff", Session("StaffId")))
        ...
        con2.Close()
        rpt.LocalReport.ReportPath = Server.MapPath("~/content/app/Account/payslip.rdlc")
