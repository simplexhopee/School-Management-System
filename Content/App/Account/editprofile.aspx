<%@ Page Title="" Language="VB" MasterPageFile="~/digicontentapp.master" AutoEventWireup="false" CodeFile="editprofile.aspx.vb" Inherits="Admin_addteacher" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Wizard ID="Wizard1" OnNextButtonClick="Wizard1_NextButtonClick" width="100%" runat="server" ActiveStepIndex="0" style="font-size: small" DisplaySideBar="False"  FinishDestinationPageUrl="~/content/app/staff/staffprofile.aspx">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="form-select-list">
                                                                       <asp:DropDownList enabled="false" cssclass = "form-control custom-select-value" ID="cboSex" runat="server"  >
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                                                                <asp:Textbox enabled="false" cssclass="form-control" ID="datepicker1" runat="server"  ></asp:Textbox>
                                                                                            </div>
                                                                    </div> 
                                                            </div>
                                                                </div> 
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                   <asp:Textbox cssclass="form-control" enabled="false" ID="txtPhone" runat="server"  ></asp:TextBox>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <asp:Textbox cssclass="form-control" enabled="false" ID="txtEmail" runat="server"  ></asp:TextBox>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <asp:Textbox cssclass="form-control" enabled="false" ID="txtAddress" runat="server" TextMode="MultiLine"  ></asp:TextBox>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <asp:Textbox cssclass="form-control" ID="txtBank" runat="server"  ></asp:Textbox>
                                                         ...
                                                         <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="form-select-list">
                                                                       <asp:DropDownList cssclass = "form-control custom-select-value"  ID="cboPension" runat="server"  >
