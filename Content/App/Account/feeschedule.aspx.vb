...
Partial Class Account_Default
    ...
    Sub load_mandatory()
        Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)            con.open()
            ...
            Dim cmdLoad250 As New MySql.Data.MySqlClient.MySqlCommand("SELECT * from choicefees", con)
        ...
        Try
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                ...
                If amount >= Val(lblInstall.Text.Replace(",", "")) Then
                    ...
                    readref21.Close()
                    Session("tref") = d1
                    Response.Redirect("~/content/app/afterpay.aspx?" & Session("tref"))
                Else
        ...
        Try
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.Open()
                ...
                For Each item As String In optionalfeec
                    ...
                    Loop
                    readref24.Close()
                    Dim cmdLoad24 As New MySql.Data.MySqlClient.MySqlCommand("SELECT * from choicefees where fee = ?", con)
