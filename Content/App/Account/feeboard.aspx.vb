...
Partial Class Account_Default
    ...
    Sub reverse_all()
        Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)            con.Open()
            Dim cmdSelect2sa As New MySql.Data.MySqlClient.MySqlCommand("SELECT student, paid, class from feeschedule", con)
    ...
    Sub reverse()
        Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)            con.open()
            Dim cmdSelect2sa As New MySql.Data.MySqlClient.MySqlCommand("SELECT paid, class from feeschedule where student = '" & Session("studentadd") & "' and session = '" & Session("sessionid") & "'", con)
            Dim reader2sa As MySql.Data.MySqlClient.MySqlDataReader = cmdSelect2sa.ExecuteReader
    ...
    Protected Sub btnPay_Click(sender As Object, e As EventArgs) Handles btnPay.Click
        Response.Redirect("~/content/app/account/feeschedule.aspx?" & Session("Studentadd"))
    ...
    Protected Sub btnReceipt_Click(sender As Object, e As EventArgs) Handles btnReceipt.Click
        Response.Redirect("~/content/app/student/receipt.aspx")
    End Sub
    ...
    Protected Sub BtnReverse_Click(sender As Object, e As EventArgs) Handles BtnReverse.Click
        Try
            reverse()
            Student_Details()
            Show_Alert(True, "Payment Reversed successfullly.")
        Catch ex As Exception
            Show_Alert(False, logify.error_log(sender.ToString, Replace(ex.ToString, "'", "")))
        End Try
    End Sub
