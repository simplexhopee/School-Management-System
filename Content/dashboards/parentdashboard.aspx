...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <asp:Panel runat="server" id="pnl1" visible="false">
    <div class="dash-frame"><h4><asp:Label runat="server" id="lblChild1"></asp:Label> STATS</h4></div> 
    <br />
    ...
    <div class="dash-frame"> <h4><asp:Label runat="server" id="lblChild2"></asp:Label></h4></div> 
           <br />
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="sparkline11-list shadow-reset mg-tb-30" style="margin:0;">
                                <div class="sparkline11-hd">
    ...
    <div class="row">
     ...
     <div class="dash-frame"><h4><asp:Label runat="server" id="lblchild3"></asp:Label> STATS</h4></div> 
 <br />
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="sparkline11-list shadow-reset mg-tb-30" style="margin:0;">
                                <div class="sparkline11-hd">
    ...
    <div class="row">
     ...
     <div class="dash-frame"><h4><asp:Label runat="server" id="lblChild4"></asp:Label> STATS</h4></div> 
           <br />
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="sparkline11-list shadow-reset mg-tb-30" style="margin:0;">
                                <div class="sparkline11-hd">
