            ...
            Do While student10.Read
                ...
                Else
                    If student10(3).ToString = "" Then
                        rows = rows & "<li><span class='message-serial message-cl-" & IIf(count + 1 = 1, "one", IIf(count + 1 = 2, "two", IIf(count + 1 = 3, "three", IIf(count + 1 = 4, "four", IIf(count + 1 = 5, "five", IIf(count + 1 = 6, "six", IIf(count + 1 = 7, "seven", IIf(count + 1 = 8, "eight", "one")))))))) & "'>" & count + 1 & "</span> <span class='message-info'>" & student10(2).ToString & "</span> <span class='message-time'>" & timestart(0) & ":" & timestart(1) & " - " & timeend(0) & ":" & timeend(1) & "</span></li>"

                    Else
                        rows = rows & "<li><span class='message-serial message-cl-" & IIf(count + 1 = 1, "one", IIf(count + 1 = 2, "two", IIf(count + 1 = 3, "three", IIf(count + 1 = 4, "four", IIf(count + 1 = 5, "five", IIf(count + 1 = 6, "six", IIf(count + 1 = 7, "seven", IIf(count + 1 = 8, "eight", "one")))))))) & "'>" & count + 1 & "</span> <span class='message-info'>" & student10(3).ToString & "</span> <span class='message-time'>" & timestart(0) & ":" & timestart(1) & " - " & timeend(0) & ":" & timeend(1) & "</span></li>"
