...
Partial Class Admin_staffprofile
    ...
    Protected Sub LinkButton1_Click(sender As Object, e As EventArgs) Handles LinkButton1.Click
        ...
        Response.Redirect("~/content/Admin/addteacher.aspx")
        ...
        Try
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                ...
                If active = False Then
                    ...
                    Dim enter As New MySql.Data.MySqlClient.MySqlCommand("delete from staffdept where staff = '" & Session("StaffAdd") & "'", con)
                    enter.ExecuteNonQuery()

                    Dim entera As New MySql.Data.MySqlClient.MySqlCommand("Update depts set head = '' where head = '" & Session("StaffAdd") & "'", con)
                    entera.ExecuteNonQuery()
                End If
                Dim ds As New DataTable
                ds.Columns.Add("passport")
                ds.Columns.Add("staffname")
