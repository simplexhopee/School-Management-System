<%@ Page Title="" Language="VB" MasterPageFile="~/digidashboard.master" AutoEventWireup="false" CodeFile="addstudent.aspx.vb" Inherits="Admin_adminpage" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                ...
                <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="0" OnNextButtonClick="Wizard1_NextButtonClick" style="font-size: small" DisplaySideBar="False" Width="100%" FinishDestinationPageUrl="~/content/Admin/studentprofile.aspx">
...
<div class="row">
            ...
            <asp:WizardStep ID="clas" runat="server" Title="clas">
                 <div class="row">
                        <div class="col-lg-12">
                            <div class="sparkline12-list shadow-reset mg-t-30">
                                <div class="sparkline12-hd">
...
<div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Class Admitted into</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <div class="form-select-list">
 ...
 <div class="all-form-element-inner">
    ...
    <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Parent ID/ Parent Phone Number</label>
                                                                </div>
                                                                <div class="col-lg-9">
