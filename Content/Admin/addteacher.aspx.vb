...
Partial Class Admin_addteacher
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If check.Check_Admin(Session("roles"), Session("usertype")) = False And check.Check_Account(Session("roles"), Session("usertype")) = False Then Response.Redirect("~/default.aspx")
                ...
                If Wizard1.ActiveStep Is WizardStep1 Then
                    Try
                        ...
                        If Session("staffadd") <> Nothing Then
                            If (rcomfirm.HasRows = True And Session("staffadd") = txtID.Text) Or (rcomfirm.HasRows = False And Session("staffadd") <> txtID.Text) Then
                                rcomfirm.Close()
                                Dim cmdCheck3 As New MySql.Data.MySqlClient.MySqlCommand("Update StaffProfile Set surname = ?, sex = ?, phone = ?,  address = ?, email = ?, designation = ?, staffid = ? Where staffID = '" & Session("staffadd") & "'", con)
                                ...
                                If Session("staffadd") <> Nothing Then
                                    Dim cmdInsert2 As New MySql.Data.MySqlClient.MySqlCommand("Update classteacher set teacher = '" & txtID.Text & "' where teacher  = '" & Session("staffadd") & "'", con)
                                    cmdInsert2.ExecuteNonQuery()
                                End If

                                If Session("staffadd") <> Nothing Then
                                    Dim cmdInsert2 As New MySql.Data.MySqlClient.MySqlCommand("Update classsubjects set teacher = '" & txtID.Text & "' where teacher  = '" & Session("staffadd") & "'", con)
                                    cmdInsert2.ExecuteNonQuery()
                                End If

                                If Session("staffadd") <> Nothing Then
                                    Dim cmdInsert2 As New MySql.Data.MySqlClient.MySqlCommand("Update staffdept set staff = '" & txtID.Text & "' where staff  = '" & Session("staffadd") & "'", con)
                                    cmdInsert2.ExecuteNonQuery()
                                End If

                                If Session("staffadd") <> Nothing Then
                                    Dim cmdInsert2 As New MySql.Data.MySqlClient.MySqlCommand("Update acclogin set username = '" & txtID.Text & "' where username  = '" & Session("staffadd") & "'", con)
                                    cmdInsert2.ExecuteNonQuery()
                                End If
                                If Session("staffadd") <> Nothing Then
                                    Dim cmdInsert2 As New MySql.Data.MySqlClient.MySqlCommand("Update admin set username = '" & txtID.Text & "' where username  = '" & Session("staffadd") & "'", con)
                                    cmdInsert2.ExecuteNonQuery()
                                End If

                                If Session("staffadd") <> Nothing Then
                                    Dim cmdInsert2 As New MySql.Data.MySqlClient.MySqlCommand("Update assignments set teacher = '" & txtID.Text & "' where teacher  = '" & Session("staffadd") & "'", con)
                                    cmdInsert2.ExecuteNonQuery()
                                End If
                                If Session("staffadd") <> Nothing Then
                                    Dim cmdInsert2 As New MySql.Data.MySqlClient.MySqlCommand("Update communicate set senderid = '" & txtID.Text & "' where senderid  = '" & Session("staffadd") & "'", con)
                                    cmdInsert2.ExecuteNonQuery()
                                End If
                                If Session("staffadd") <> Nothing Then
                                    Dim cmdInsert2 As New MySql.Data.MySqlClient.MySqlCommand("Update depts set superior = '" & txtID.Text & "' where superior  = '" & Session("staffadd") & "'", con)
                                    cmdInsert2.ExecuteNonQuery()
                                End If
                                If Session("staffadd") <> Nothing Then
                                    Dim cmdInsert2 As New MySql.Data.MySqlClient.MySqlCommand("Update elearning set teacher = '" & txtID.Text & "' where teacher  = '" & Session("staffadd") & "'", con)
                                    cmdInsert2.ExecuteNonQuery()
                                End If
                                If Session("staffadd") <> Nothing Then
                                    Dim cmdInsert2 As New MySql.Data.MySqlClient.MySqlCommand("Update messages set sender = '" & txtID.Text & "' where sender  = '" & Session("staffadd") & "'", con)
                                    cmdInsert2.ExecuteNonQuery()
                                End If
                                If Session("staffadd") <> Nothing Then
                                    Dim cmdInsert2 As New MySql.Data.MySqlClient.MySqlCommand("Update messages set receiver = '" & txtID.Text & "' where receiver  = '" & Session("staffadd") & "'", con)
                                    cmdInsert2.ExecuteNonQuery()
                                End If
                                If Session("staffadd") <> Nothing Then
                                    Dim cmdInsert2 As New MySql.Data.MySqlClient.MySqlCommand("Update sentmsgs set sender = '" & txtID.Text & "' where sender  = '" & Session("staffadd") & "'", con)
                                    cmdInsert2.ExecuteNonQuery()
                                End If
                                If Session("staffadd") <> Nothing Then
                                    Dim cmdInsert2 As New MySql.Data.MySqlClient.MySqlCommand("Update sentmsgs set receiver = '" & txtID.Text & "' where receiver  = '" & Session("staffadd") & "'", con)
                                    cmdInsert2.ExecuteNonQuery()
                                End If
                                If Session("staffadd") <> Nothing Then
                                    Dim cmdInsert2 As New MySql.Data.MySqlClient.MySqlCommand("Update notifications set origin = '" & txtID.Text & "' where origin  = '" & Session("staffadd") & "'", con)
                                    cmdInsert2.ExecuteNonQuery()
                                End If
                                If Session("staffadd") <> Nothing Then
                                    Dim cmdInsert2 As New MySql.Data.MySqlClient.MySqlCommand("Update notifications set recipient = '" & txtID.Text & "' where recipient  = '" & Session("staffadd") & "'", con)
                                    cmdInsert2.ExecuteNonQuery()
                                End If
                               
                                If Session("staffadd") <> Nothing Then
                                    Dim cmdInsert2 As New MySql.Data.MySqlClient.MySqlCommand("Update salschedule set staffid = '" & txtID.Text & "' where staffid  = '" & Session("staffadd") & "'", con)
                                    cmdInsert2.ExecuteNonQuery()
                                End If
                                If Session("staffadd") <> Nothing Then
                                    Dim cmdInsert2 As New MySql.Data.MySqlClient.MySqlCommand("Update timetable set teacher = '" & txtID.Text & "' where teacher  = '" & Session("staffadd") & "'", con)
                                    cmdInsert2.ExecuteNonQuery()
                                End If
                                ...
                                Response.Redirect("~/content/admin/staffprofile.aspx")
                            Else
                                Show_Alert(False, "Staff ID already exists")
                                e.Cancel = True
                            End If
                        ElseIf rcomfirm.HasRows = False And Session("staffadd") = Nothing Then
                            rcomfirm.Close()
                        ...
                        Else
                            rcomfirm.Close()
                            Show_Alert(False, "Staff ID exists.")
                            e.Cancel = True
