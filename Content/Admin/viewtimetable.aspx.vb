...
Partial Class Default2
            ...
            If cboDay.Text <> "Select Day" Then
                ...
                Do While student10.Read
                    ...
                    If student10(2).ToString = "Tutorial" Then
                        ...
                        hype.DataTextField = a(0) & ":" & a(1) & " - " & b(0) & ":" & b(1)
                        ds.Columns.Add("edit" & j)
                        ds.Columns.Add("edit" & j + 1)
                        hype.DataNavigateUrlFormatString = "~/content/admin/viewtimetable.aspx?timetable=" + Request.QueryString("timetable") + "&school=" + Request.QueryString("school") + "&day=" + cboDay.Text + "&period={0}&class={1}"
                        hype.DataNavigateUrlFields = array
                        hype.HeaderText = a(0) & ":" & a(1) & " - " & b(0) & ":" & b(1)
                    ...
                    Else
                        ...
                        nonteaching.HeaderText = a(0) & ":" & a(1) & " - " & b(0) & ":" & b(1)
                        nonteaching.DataField = a(0) & ":" & a(1) & " - " & b(0) & ":" & b(1)
                ...
                For Each item As String In classes
                    ...
                    Do While student10z.Read
                        Dim a As Array = Split(student10z(2).ToString, ":")
                        Dim b As Array = Split(student10z(3).ToString, ":")
                        For h = 1 To ds.Columns.Count - 1
                            Dim nonotlink As Integer = 0
                            If ds.Columns(h).ColumnName = a(0) & ":" & a(1) & " - " & b(0) & ":" & b(1) Then
                                For Each vb As Integer In nontutorial
                                    If vb <= h Then
                                        nonotlink = nonotlink + 1
                                    End If
    ...
    Protected Sub LinkButton1_Click(sender As Object, e As EventArgs) Handles LinkButton1.Click
        Response.Redirect("~/content/admin/managetimetable.aspx")
    End Sub
