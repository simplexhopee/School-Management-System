<%@ Page Language="VB" AutoEventWireup="false"  MasterPageFile="~/digidashboard.master" CodeFile="classtimetable.aspx.vb" Inherits="Default2"  %>
...
<div class="row">
      ...
      <asp:Panel ID="Panel1" runat="server">
          ...
          <asp:GridView ID="GridView1" AutoGenerateColumns ="False"   runat="server" GridLines="both" class="newtable">
