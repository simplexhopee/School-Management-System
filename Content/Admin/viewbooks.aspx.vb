...
Partial Class Admin_allstudents
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)
            ...
            Dim cmdCheck As New MySql.Data.MySqlClient.MySqlCommand("Select id, bookname, file from books where id = '" & Request.QueryString.ToString & "'", con)
            ...
            byts = wc.DownloadData("https://" & Request.Url.Authority & "/Content" & Replace(reada(2).ToString, "~", ""))
