<%@ Page Title="" Language="VB" MasterPageFile="~/digidashboard.master" AutoEventWireup="false" CodeFile="manageclass.aspx.vb" Inherits="Admin_newsession" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="comment-replay-profile">
                                                            <div class="btn-group" id="Div2" style="width:100%;">
                                                                 <div class="row">
        <div class="col-lg-4">
     <asp:GridView  runat="server" autogeneratecolumns ="False" ID="Gridview1" ShowHeader="False" GridLines="Horizontal" class="newtable  tableflat" >
                     <Columns>
 ...
 <div class="all-form-element-inner">
     <div class="comment-replay-profile">
                                                            <div class="btn-group" id="grid" style="width:100%;">
                                                                 <div class="row">
        <div class="col-lg-4">
     <asp:GridView ID="GridView2"  AutoGenerateColumns="False" ShowHeader="False"  runat="server" GridLines="Horizontal" class="newtable tableflat">
              ...
              <Columns>
                 ...
                 <asp:boundfield datafield="subject" HeaderText="Subject" >
                                  ...
                                  <asp:boundfield datafield="name" HeaderText="Teacher" >
                                             ...
                                             <asp:BoundField DataField="periods" HeaderText="Periods">
                   
                   </asp:BoundField>
                   <asp:HyperLinkField DataTextField="View" DataNavigateUrlFields="subject"  DataNavigateUrlFormatString="~/content/Admin/subjectallocate.aspx?{0}" > 
                   <controlstyle cssclass="btn btn-white btn-xs btn-group comment-replay-profile " /></asp:hyperlinkfield>
        
                   <asp:CommandField DeleteText="Remove" ShowDeleteButton="True"><controlstyle cssclass="btn btn-white btn-xs btn-group comment-replay-profile " /> 
                   </asp:CommandField>
