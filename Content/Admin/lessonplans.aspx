<%@ Page Title="" Language="VB" MasterPageFile="~/digidashboard.master" AutoEventWireup="false" CodeFile="lessonplans.aspx.vb" Inherits="Admin_allstudents" %>
                            ...
                            <div class="sparkline12-list shadow-reset mg-t-30">
                                <div class="sparkline12-hd">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <asp:Label ID="Label1" Font-Bold="true" Font-Size="Larger" runat="server" Text="Templates"></asp:Label>
          ...
          <div class="row">
                   <div class="col-lg-5">
                                                        <div class="comment-replay-profile">
                                                            <div class="btn-group">         
    <asp:Button ID="btnMsg" class="btn btn-white btn-xs" TabIndex="8"  runat="server" Text="New Template" ></asp:Button>
                                                            </div></div> </div> </div> 
         <br />
        ...
        <div class="col-lg-12">
          <asp:GridView ID="GridView1" AutoGenerateColumns="False" runat="server" AllowPaging="True" PageSize="40" GridLines="None" class="newtable" >
             <Columns>
                   ...
                   <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="~/Content/Admin/newtemplate.aspx?{0}" Text="View" >
                       <controlstyle cssclass="btn btn-white btn-xs btn-group comment-replay-profile" />
                   </asp:HyperLinkField>

            <asp:boundfield datafield="name" headertext="Templates"/>
