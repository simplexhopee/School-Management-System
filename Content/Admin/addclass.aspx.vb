            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                If Wizard1.ActiveStepIndex = 0 Then
                    ...
                    If cbotype.Text = "Select Type" Then
                        ...
                        Exit Sub
                    End If
                    If cboNextClass.Text = "Select Class" Then
                        Show_Alert(False, "Please select next class")
                        e.Cancel = True
                        Exit Sub
                    End If
                    ...
                    Else
                        ...
                        Else
                            ...
                            reader5.Close()
                            Dim cmd3 As New MySql.Data.MySqlClient.MySqlCommand("INSERT Into Class (Class, type, superior, cano, nextclass) Values (?,?,?,?,?)", con)
                            ...
                            cmd3.Parameters.Add(New MySql.Data.MySqlClient.MySqlParameter("dtf", nextclass))
