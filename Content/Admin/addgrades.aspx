<%@ Page Title="" Language="VB" MasterPageFile="~/digidashboard.master" AutoEventWireup="false" CodeFile="addgrades.aspx.vb" Inherits="Admin_addclass" %>

<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h2>ADD GRADING SYSTEM</h2>
    
    <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="0"  style="font-size: small" DisplaySideBar="False" Width="100%" startNextButtonCss="btn-small btn-skin btn-block btn-lg" FinishDestinationPageUrl="~/content/Admin/managegrades.aspx">
 ...
 <div class="all-form-element-inner">
     ...
     <asp:GridView  runat="server" autogeneratecolumns ="false" ID="Gridview1" GridLines="None" class="newtable">
                     <Columns>
