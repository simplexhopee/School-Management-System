        ...
        Try
            ...
            If ChkPortal.Checked = True Then
                For Each item As String In recipient
                   ...
                   If z = "Admin" Then
                        ...
                        For Each q In d
                          msgobj.Send_Email(msgobj.Get_Email(q), txtSubject.Text, message, "http://" & Request.Url.Authority, "Admin", s.Get_Staff_Name(Session("staffid")))
                    ...
                    ElseIf z = "Accounts" Then
                        ...
                        Next
                        	 ...
                        	 msgobj.Send_Email(msgobj.Get_Email(z), txtSubject.Text, message, "http://" & Request.Url.Authority, "Admin", s.Get_Staff_Name(Session("staffid")))
                    ...
                    If z = "Admin" Then
                        Dim d As ArrayList = s.Fetch_admins
                        For Each q In d
                            logify.Notifications("You have a new message - " & txtSubject.Text, q, Session("staffid"), "Admin", "~/content/admin/readmsg.aspx?" & y, "Message")
                        Next
                    ElseIf z = "Accounts" Then
                        Dim d As ArrayList = s.Fetch_accounts
                        For Each q In d
                            logify.Notifications("You have a new message - " & txtSubject.Text, q, Session("staffid"), "Admin", "~/content/account/readmsg.aspx?" & y, "Message")
                        Next
                    ElseIf receiver = "STAFF" Then
                        logify.Notifications("You have a new message - " & txtSubject.Text, z, Session("staffid"), "Admin", "~/content/staff/readmsg.aspx?" & y, "Message")
                    ElseIf receiver = "PARENTS" Then
                        logify.Notifications("You have a new message - " & txtSubject.Text, z, Session("staffid"), "Admin", "~/content/parent/readmsg.aspx?" & y, "Message")
                    End If
                    recno = recno + 1
                Next
            End If
            ...
            If ChkPortal.Checked = True Then
               If LinkButton1.Text <> "" Then
                ...
                End If
                msgobj.Send_Msg_Sent(y, recno & " Recipients", "Admin", Session("staffid"), txtSubject.Text, message, Session("sessionid"), j, Session("ReceiverReply"))
        ...
        Try
            ...
            If FileUpload1.HasFile Then
                ...
                If LinkButton1.Text = "" Then
                    ...
                    LinkButton1.OnClientClick = "window.open('viewpdf.aspx?1','name', 'toolbar=1, scrollbars=1, location=1, statusbar=0, menubar=1, resizable=1, width=800, height=600')"
                    Session("pic1") = q
                    Session("pic1type") = type
                    Panel1.Visible = True
                    del1.Text = "Delete"
