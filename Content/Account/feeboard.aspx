<%@ Page Title="" Language="VB" MasterPageFile="~/digidashboard.master" AutoEventWireup="false" CodeFile="feeboard.aspx.vb" Inherits="Account_Default" %>
 ...
 <div class="all-form-element-inner">
        <div class="row">
                   <div class="col-lg-5">
                                                        <div class="comment-replay-profile">
                                                            <div class="btn-group">         
    <asp:Button ID="Button3" class="btn btn-white btn-xs"  runat="server" Text="All Children"></asp:Button> <asp:Button ID="btnChange" visible="false" class="btn btn-white btn-xs"  runat="server" Text="Payment Options"></asp:Button></div></div> </div> </div>    
     <br />
   ...
   <asp:Panel id="pnlOption" visible="false" runat="server">
     ...
     <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <h4>Select Payment Preference</h4>
                                                                     <asp:RadioButtonList id="radType" runat="server" autopostback="true">
     <asp:ListItem Value="Termly"></asp:ListItem>
      ...
      <asp:Panel id="pnlDetails" visible="false" runat="server">
          <asp:Panel id="pnlQuarter" visible="false" runat="server">
              <table class ="newtable" style="width:50%;">
            <tr>
                <td  class="auto-style9" >
                     
                    <asp:Label ID="Label5" runat="server"  Text="Current Quarter" style="font-weight: 700"></asp:Label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <td class="auto-style8"  >
                    ...
                    <asp:Label ID="lblQuarter" runat="server"  style="text-align: right;"></asp:Label>
             ...
             <tr>
                <td class="auto-style9" >
                      <asp:Label ID="Label6" visible="false" runat="server"  Text="Payments made in advance" style="font-weight: 700"></asp:Label>
                    &nbsp;</td>
                <td class="auto-style8"  >
