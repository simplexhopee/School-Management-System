...
Partial Class Admin_allstudents
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                Dim cmdLoad1 As New MySql.Data.MySqlClient.MySqlCommand("SELECT id, cast(date as char) as date, sender, sendertype, subject, status from messages where receiver = '" & "Accounts" & "'  order by date desc", con)
                ...
                For Each item As String In id
                    If sendertype(x) = "Parent" Then
                        Dim cmdLoad As New MySql.Data.MySqlClient.MySqlCommand("SELECT parentname from parentprofile where parentid = '" & sendere(x) & "'", con)
            ...
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                ...
                For Each item As String In id
                    ...
                    ElseIf sendertype(x) = "Admin" Then
                        ...
                        senderrel.Add("")
                    ElseIf sendertype(x) = "Account" Then
                        senderrel.Add("")
                    End If
                    ds.Rows.Add(item, Convert.ToDateTime(dates(x)).ToString("dd/MM/yyyy hh:mm tt"), sendername(x), senderrel(x), subject(x), status(x))
                    x = x + 1
    ...
    Protected Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Try
            Using con As New MySql.Data.MySqlClient.MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PortalDBConnectionString").ConnectionString)                con.open()
                Dim cmdLoad1 As New MySql.Data.MySqlClient.MySqlCommand("SELECT id, cast(date as char) as date, sender, sendertype, subject, status from messages where receiver = '" & "Accounts" & "' and subject like ? order by date desc", con)
    ...
    Protected Sub btnMsg_Click(sender As Object, e As EventArgs) Handles btnMsg.Click
        Response.Redirect("~/content/Account/newmsg.aspx")
    End Sub

    Protected Sub LinkButton1_Click(sender As Object, e As EventArgs) Handles LinkButton1.Click
        Response.Redirect("~/content/Account/sentmsgs.aspx")
    End Sub
End Class
