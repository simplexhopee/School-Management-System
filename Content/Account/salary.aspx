<%@ Page Title="" Language="VB" MasterPageFile="~/digidashboard.master" AutoEventWireup="false" CodeFile="salary.aspx.vb" Inherits="Account_salary" %>
 ...
 <div class="all-form-element-inner">
    ...
    <asp:Button ID="Button1" class="btn btn-white btn-xs" TabIndex="8"  runat="server" Text="Pay" ></asp:Button>     </div></div>
     ...
     <div class="comment-replay-profile">
                ...
                <asp:GridView ID="GridView1" runat="server" AllowSorting="True"   AutoGenerateEditButton="True" AutoGenerateColumns="False"  OnRowEditing="GridView1_RowEditing" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowUpdating="GridView1_RowUpdating" GridLines="None" class="newtable" >
                <columns>
