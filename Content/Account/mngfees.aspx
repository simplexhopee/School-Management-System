<%@ Page Title="" Language="VB" MasterPageFile="~/digidashboard.master" AutoEventWireup="false" CodeFile="mngfees.aspx.vb" Inherits="Account_salary" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div class="all-form-element-inner">
     <div class="comment-replay-profile">
      ...
      <asp:GridView id="Gridview1" runat="server" autogeneratecolumns="False" GridLines="None" class="newtable">
        <Columns>
<asp:BoundField DataField="id" HeaderText="ID"></asp:BoundField>
            ...
            <asp:BoundField DataField="install" HeaderText="Minimum Installment (%)"></asp:BoundField>
             <asp:BoundField DataField="monthly" HeaderText="Monthly Amount"></asp:BoundField>
            <asp:BoundField DataField="quarterly" HeaderText="Quarterly Amount"></asp:BoundField>
...
<div class="row">
         ...
         <asp:Panel runat="server" id="jhhd" visible="false">
          <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Monthly Amount (Optional)</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                     <asp:Textbox class="form-control" ID="txtClassMonthly" runat="server"  ></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
           <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Quarterly Amount (Optional)</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                     <asp:Textbox class="form-control" ID="txtClassQuarterly" runat="server"  ></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
             </asp:Panel>
 ...
 <div class="all-form-element-inner">
     <div class="comment-replay-profile">
      ...
      <asp:GridView id="Gridview7" runat="server" autogeneratecolumns="False" GridLines="None" class="newtable">
        <Columns>
<asp:BoundField DataField="id" HeaderText="ID"></asp:BoundField>
            <asp:BoundField DataField="class" HeaderText="Class"></asp:BoundField>
            <asp:BoundField DataField="fee" HeaderText="Fee" ReadOnly="True"></asp:BoundField>
...
<div class="row">
 ...
 <div class="all-form-element-inner">
     <div class="comment-replay-profile">
      ...
      <asp:GridView id="Gridview8" runat="server" autogeneratecolumns="False" GridLines="None" class="newtable">
        <Columns>
<asp:BoundField DataField="id" HeaderText="ID"></asp:BoundField>
            <asp:BoundField DataField="class" HeaderText="Class"></asp:BoundField>
            <asp:BoundField DataField="fee" HeaderText="Fee" ReadOnly="True"></asp:BoundField>
...
<div class="row">
 ...
 <div class="all-form-element-inner">
     <div class="comment-replay-profile">
      ...
      <asp:GridView id="Gridview2" runat="server" autogeneratecolumns="False" GridLines="None" class="newtable">
        <Columns>
<asp:BoundField DataField="id" HeaderText="ID" ReadOnly="True"></asp:BoundField>
 ...
 <div class="all-form-element-inner">
     <div class="comment-replay-profile">
      ...
      <asp:GridView id="Gridview3" runat="server" autogeneratecolumns="False" GridLines="None" class="newtable">
        <Columns>
<asp:BoundField DataField="id" HeaderText="ID" ReadOnly="True"></asp:BoundField>
            <asp:BoundField DataField="fee" HeaderText="Fee" ReadOnly="True"></asp:BoundField>
            <asp:BoundField DataField="amount" HeaderText="Amount"></asp:BoundField>
 ...
 <div class="all-form-element-inner">
     <div class="comment-replay-profile">
      ...
      <asp:GridView id="Gridview4" runat="server" autogeneratecolumns="False" GridLines="None" class="newtable">
        <Columns>
<asp:BoundField DataField="id" HeaderText="ID" ReadOnly="True"></asp:BoundField>
            <asp:BoundField DataField="fee" HeaderText="Fee" ReadOnly="True"></asp:BoundField>
            <asp:BoundField DataField="amount" HeaderText="Amount"></asp:BoundField>
 ...
 <div class="all-form-element-inner">
     <div class="comment-replay-profile">
      ...
      <asp:GridView id="Gridview5" runat="server" autogeneratecolumns="False" GridLines="None" class="newtable">
        <Columns>
          ...
          <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                     ...
                                                                     <asp:CheckBox ID = "clsSp" runat="server" Checked="False"  Text="Class Specific" AutoPostBack="true"   /></label> 
                                                                </div>
                                                                ...
                                                                <div class="col-lg-9">
                                                                   ...
                                                                   <div class="form-select-list">
                                                                       <asp:DropDownList  cssclass = "form-control custom-select-value" ID="cboCopyClass" runat="server"  autopostback="true" >
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Monthly Amount</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                     <asp:Textbox class="form-control" ID="txtOptMonthly" runat="server"  ></asp:TextBox>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Quarterly Amount</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                     <asp:Textbox class="form-control" ID="txtOptQuarterly" runat="server"  ></asp:TextBox>
                                                                </div>
 ...
 <div class="all-form-element-inner">
     <div class="comment-replay-profile">
      ...
      <asp:GridView id="Gridview6" runat="server" autogeneratecolumns="False" GridLines="None" class="newtable">
        <Columns>
