                ...
                If Request.QueryString.ToString <> Nothing And Not IsPostBack Then
                    ...
                    For Each item As String In recipients
                        If rectype = "Student" Then
                            ...
                            student.Read()
                            ds.Rows.Add(student(0).ToString)
                            student.Close()
                        ElseIf rectype = "Staff" Then
                            ...
                            Else
                                ...
                                student1.Read()
                                ds.Rows.Add(student1(0).ToString)
                                student1.Close()
                            End If
                        ElseIf rectype = "Parent" Then
                            Dim cmdLoad11 As New MySql.Data.MySqlClient.MySqlCommand("SELECT parentname from parentprofile where parentid = '" & item & "'", con)
                            Dim student1 As MySql.Data.MySqlClient.MySqlDataReader = cmdLoad11.ExecuteReader
                            student1.Read()
